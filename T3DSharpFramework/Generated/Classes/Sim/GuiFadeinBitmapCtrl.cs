...
namespace T3DSharpFramework.Generated.Classes.Sim {
    ...
    public class GuiFadeinBitmapCtrl : GuiBitmapCtrl {
        ...
        new internal struct InternalUnsafeMethods {
            ...
            internal static _OnDone OnDone() {
               _OnDoneFunc ??= Torque3D.LookupEngineFunction<_OnDone>("cbGuiFadeinBitmapCtrl_onDone");
            ...
            internal static _Click Click() {
               _ClickFunc ??= Torque3D.LookupEngineFunction<_Click>("cbGuiFadeinBitmapCtrl_click");
            ...
            internal static _StaticGetType StaticGetType() {
               _StaticGetTypeFunc ??= Torque3D.LookupEngineFunction<_StaticGetType>("fnGuiFadeinBitmapCtrl_staticGetType");
            ...
            internal static _Create Create() {
               _CreateFunc ??= Torque3D.LookupEngineFunction<_Create>("fnGuiFadeinBitmapCtrl_create");
