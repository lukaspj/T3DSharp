...
namespace T3DSharpFramework.Generated.Classes.Sim {
    ...
    /// </code>
    public class SFXPlayList : SFXTrack {
        ...
        new internal struct InternalUnsafeMethods {
            ...
            internal static _StaticGetType StaticGetType() {
               _StaticGetTypeFunc ??= Torque3D.LookupEngineFunction<_StaticGetType>("fnSFXPlayList_staticGetType");
            ...
            internal static _Create Create() {
               _CreateFunc ??= Torque3D.LookupEngineFunction<_Create>("fnSFXPlayList_create");
        ...
        /// <value>
        /// <summary>Track "Track to play in this slot.\n" "This must be set for the slot to be considered for playback.  Other settings for a slot " "will not take effect except this field is set."</summary>
        /// </value>
        public DynamicFieldVector<string> Track {
        ...
        /// <value>
        /// <summary>Track asset "Track to play in this slot.\n" "This must be set for the slot to be considered for playback.  Other settings for a slot " "will not take effect except this field is set.".</summary>
        /// </value>
        public DynamicFieldVector<string> TrackAsset {
            get => new DynamicFieldVector<string>(
                    this, 
                    "TrackAsset", 
                    12, 
