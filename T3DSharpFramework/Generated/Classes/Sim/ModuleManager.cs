...
namespace T3DSharpFramework.Generated.Classes.Sim {
    /// 
    public class ModuleManager : SimObject {
        ...
        new internal struct InternalUnsafeMethods {
            ...
            internal static _StaticGetType StaticGetType() {
               _StaticGetTypeFunc ??= Torque3D.LookupEngineFunction<_StaticGetType>("fnModuleManager_staticGetType");
            ...
            internal static _Create Create() {
               _CreateFunc ??= Torque3D.LookupEngineFunction<_Create>("fnModuleManager_create");
            ...
            internal static _IgnoreLoadedGroups IgnoreLoadedGroups() {
               _IgnoreLoadedGroupsFunc ??= Torque3D.LookupEngineFunction<_IgnoreLoadedGroups>("fnModuleManager_ignoreLoadedGroups");
            ...
            internal static _RemoveListener RemoveListener() {
               _RemoveListenerFunc ??= Torque3D.LookupEngineFunction<_RemoveListener>("fnModuleManager_removeListener");
            ...
            internal static _AddListener AddListener() {
               _AddListenerFunc ??= Torque3D.LookupEngineFunction<_AddListener>("fnModuleManager_addListener");
            ...
            internal static _MergeModules MergeModules() {
               _MergeModulesFunc ??= Torque3D.LookupEngineFunction<_MergeModules>("fnModuleManager_mergeModules");
            ...
            internal static _CanMergeModules CanMergeModules() {
               _CanMergeModulesFunc ??= Torque3D.LookupEngineFunction<_CanMergeModules>("fnModuleManager_canMergeModules");
            ...
            internal static _IsModuleMergeAvailable IsModuleMergeAvailable() {
               _IsModuleMergeAvailableFunc ??= Torque3D.LookupEngineFunction<_IsModuleMergeAvailable>("fnModuleManager_isModuleMergeAvailable");
            ...
            internal static _SynchronizeDependencies SynchronizeDependencies() {
               _SynchronizeDependenciesFunc ??= Torque3D.LookupEngineFunction<_SynchronizeDependencies>("fnModuleManager_synchronizeDependencies");
            ...
            internal static _RenameModule RenameModule() {
               _RenameModuleFunc ??= Torque3D.LookupEngineFunction<_RenameModule>("fnModuleManager_renameModule");
            ...
            internal static _CopyModule CopyModule() {
               _CopyModuleFunc ??= Torque3D.LookupEngineFunction<_CopyModule>("fnModuleManager_copyModule");
            ...
            internal static _FindModuleTypes FindModuleTypes() {
               _FindModuleTypesFunc ??= Torque3D.LookupEngineFunction<_FindModuleTypes>("fnModuleManager_findModuleTypes");
            ...
            internal static _FindModules FindModules() {
               _FindModulesFunc ??= Torque3D.LookupEngineFunction<_FindModules>("fnModuleManager_findModules");
            ...
            [StructLayout(LayoutKind.Sequential)]
            internal struct FindModuleByFilePath__Args
            {
                [MarshalAs(UnmanagedType.LPUTF8Str)]
            ...
            internal delegate IntPtr _FindModuleByFilePath(IntPtr _this, FindModuleByFilePath__Args args);
            private static _FindModuleByFilePath _FindModuleByFilePathFunc;
            internal static _FindModuleByFilePath FindModuleByFilePath() {
               _FindModuleByFilePathFunc ??= Torque3D.LookupEngineFunction<_FindModuleByFilePath>("fnModuleManager_findModuleByFilePath");

                return _FindModuleByFilePathFunc;
            }
            ...
            internal static _FindModule FindModule() {
               _FindModuleFunc ??= Torque3D.LookupEngineFunction<_FindModule>("fnModuleManager_findModule");
            ...
            internal static _UnloadExplicit UnloadExplicit() {
               _UnloadExplicitFunc ??= Torque3D.LookupEngineFunction<_UnloadExplicit>("fnModuleManager_unloadExplicit");
            ...
            internal static _LoadExplicit LoadExplicit() {
               _LoadExplicitFunc ??= Torque3D.LookupEngineFunction<_LoadExplicit>("fnModuleManager_loadExplicit");
            ...
            internal static _UnloadGroup UnloadGroup() {
               _UnloadGroupFunc ??= Torque3D.LookupEngineFunction<_UnloadGroup>("fnModuleManager_unloadGroup");
            ...
            internal static _LoadGroup LoadGroup() {
               _LoadGroupFunc ??= Torque3D.LookupEngineFunction<_LoadGroup>("fnModuleManager_loadGroup");
            ...
            internal static _UnregisterModule UnregisterModule() {
               _UnregisterModuleFunc ??= Torque3D.LookupEngineFunction<_UnregisterModule>("fnModuleManager_unregisterModule");
            ...
            internal static _RegisterModule RegisterModule() {
               _RegisterModuleFunc ??= Torque3D.LookupEngineFunction<_RegisterModule>("fnModuleManager_registerModule");
            ...
            internal static _ScanModules ScanModules() {
               _ScanModulesFunc ??= Torque3D.LookupEngineFunction<_ScanModules>("fnModuleManager_scanModules");
            ...
            internal static _SetModuleExtension SetModuleExtension() {
               _SetModuleExtensionFunc ??= Torque3D.LookupEngineFunction<_SetModuleExtension>("fnModuleManager_setModuleExtension");
        ...
        /// <param name="loadedOnly">Whether to return only modules that are loaded or not.</param>
        /// <returns>A list of space - separated module definition object Ids.</returns>
        public string FindModules(bool loadedOnly = true) {
        ...
        public string FindModuleByFilePath(string filePath = "") {
             InternalUnsafeMethods.FindModuleByFilePath__Args _args = new InternalUnsafeMethods.FindModuleByFilePath__Args() {
                filePath = filePath,
             };
             IntPtr _engineResult = InternalUnsafeMethods.FindModuleByFilePath()(ObjectPtr, _args);
             return StringMarshal.IntPtrToUtf8String(_engineResult);
        }
        ...
        /// <value>
        /// <description>
        /// Whether the module manager will fail to load an entire module group if a single module fails to load.
        /// </description>
        /// </value>
        public bool FailGroupIfModuleFail {
            get => GenericMarshal.StringTo<bool>(GetFieldValue("FailGroupIfModuleFail"));
            set => SetFieldValue("FailGroupIfModuleFail", GenericMarshal.ToString(value));
        }
    }
}
