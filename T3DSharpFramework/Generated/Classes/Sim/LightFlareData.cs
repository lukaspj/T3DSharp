...
namespace T3DSharpFramework.Generated.Classes.Sim {
    ...
    /// </description>
    /// <code>
    /// // example from Full Template, core/art/datablocks/lights.tscript
    ...
    /// };
    /// </code>
    public class LightFlareData : SimDataBlock {
        ...
        new internal struct InternalUnsafeMethods {
            ...
            internal static _Apply Apply() {
               _ApplyFunc ??= Torque3D.LookupEngineFunction<_Apply>("fnLightFlareData_apply");
            ...
            internal static _StaticGetType StaticGetType() {
               _StaticGetTypeFunc ??= Torque3D.LookupEngineFunction<_StaticGetType>("fnLightFlareData_staticGetType");
            ...
            internal static _Create Create() {
               _CreateFunc ??= Torque3D.LookupEngineFunction<_Create>("fnLightFlareData_create");
        ...
        /// <value>
        /// <summary>FlareTexture "The texture / sprite sheet for this flare."</summary>
        /// </value>
        ...
        /// <value>
        /// <summary>FlareTexture asset "The texture / sprite sheet for this flare.".</summary>
        /// </value>
        public string FlareTextureAsset {
            get => GenericMarshal.StringTo<string>(GetFieldValue("FlareTextureAsset"));
            set => SetFieldValue("FlareTextureAsset", GenericMarshal.ToString(value));
        }
