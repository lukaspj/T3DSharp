...
namespace T3DSharpFramework.Generated.Classes.Sim {
    ...
    public class GuiProgressBitmapCtrl : GuiTextCtrl {
        ...
        new internal struct InternalUnsafeMethods {
            ...
            internal static _SetBitmap SetBitmap() {
               _SetBitmapFunc ??= Torque3D.LookupEngineFunction<_SetBitmap>("fnGuiProgressBitmapCtrl_setBitmap");
            ...
            internal static _StaticGetType StaticGetType() {
               _StaticGetTypeFunc ??= Torque3D.LookupEngineFunction<_StaticGetType>("fnGuiProgressBitmapCtrl_staticGetType");
            ...
            internal static _Create Create() {
               _CreateFunc ??= Torque3D.LookupEngineFunction<_Create>("fnGuiProgressBitmapCtrl_create");
        ...
        /// <value>
        /// <summary>Bitmap "Bitmap file to use for rendering the progress bar.\n\n" "If the profile assigned to the control already has a bitmap assigned, this property need not be " "set in which case the bitmap from the profile is used."</summary>
        /// </value>
        ...
        /// <value>
        /// <summary>Bitmap asset "Bitmap file to use for rendering the progress bar.\n\n" "If the profile assigned to the control already has a bitmap assigned, this property need not be " "set in which case the bitmap from the profile is used.".</summary>
        /// </value>
