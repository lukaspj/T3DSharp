...
namespace T3DSharpFramework.Generated.Classes.Sim {
    ...
    /// };
    /// </code>
    public class GuiDynamicCtrlArrayControl : GuiControl {
        ...
        new internal struct InternalUnsafeMethods {
            ...
            internal static _Refresh Refresh() {
               _RefreshFunc ??= Torque3D.LookupEngineFunction<_Refresh>("fnGuiDynamicCtrlArrayControl_refresh");
            ...
            internal static _StaticGetType StaticGetType() {
               _StaticGetTypeFunc ??= Torque3D.LookupEngineFunction<_StaticGetType>("fnGuiDynamicCtrlArrayControl_staticGetType");
            ...
            internal static _Create Create() {
               _CreateFunc ??= Torque3D.LookupEngineFunction<_Create>("fnGuiDynamicCtrlArrayControl_create");
