...
namespace T3DSharpFramework.Generated.Classes.Sim {
    ...
    /// </description>
    public class PhysicsDebris : GameBase {
        ...
        new internal struct InternalUnsafeMethods {
            ...
            internal static _StaticGetType StaticGetType() {
               _StaticGetTypeFunc ??= Torque3D.LookupEngineFunction<_StaticGetType>("fnPhysicsDebris_staticGetType");
            ...
            internal static _Create Create() {
               _CreateFunc ??= Torque3D.LookupEngineFunction<_Create>("fnPhysicsDebris_create");
