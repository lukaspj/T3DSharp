...
namespace T3DSharpFramework.Generated.Classes.Sim {
    ...
    public class OcclusionVolume : SceneObject {
        ...
        new internal struct InternalUnsafeMethods {
            ...
            internal static _StaticGetType StaticGetType() {
               _StaticGetTypeFunc ??= Torque3D.LookupEngineFunction<_StaticGetType>("fnOcclusionVolume_staticGetType");
            ...
            internal static _Create Create() {
               _CreateFunc ??= Torque3D.LookupEngineFunction<_Create>("fnOcclusionVolume_create");
