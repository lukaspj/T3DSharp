...
namespace T3DSharpFramework.Generated.Classes.Sim {
    ...
    /// };
    /// </code>
    public class GuiStackControl : GuiControl {
        ...
        new internal struct InternalUnsafeMethods {
            ...
            internal static _UpdateStack UpdateStack() {
               _UpdateStackFunc ??= Torque3D.LookupEngineFunction<_UpdateStack>("fnGuiStackControl_updateStack");
            ...
            internal static _Freeze Freeze() {
               _FreezeFunc ??= Torque3D.LookupEngineFunction<_Freeze>("fnGuiStackControl_freeze");
            ...
            internal static _IsFrozen IsFrozen() {
               _IsFrozenFunc ??= Torque3D.LookupEngineFunction<_IsFrozen>("fnGuiStackControl_isFrozen");
            ...
            internal static _StaticGetType StaticGetType() {
               _StaticGetTypeFunc ??= Torque3D.LookupEngineFunction<_StaticGetType>("fnGuiStackControl_staticGetType");
            ...
            internal static _Create Create() {
               _CreateFunc ??= Torque3D.LookupEngineFunction<_Create>("fnGuiStackControl_create");
