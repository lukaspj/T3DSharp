...
namespace T3DSharpFramework.Generated.Classes.Sim {
    ...
    /// <see cref="GuiControl" />
    public class GuiProgressCtrl : GuiTextCtrl {
        ...
        new internal struct InternalUnsafeMethods {
            ...
            internal static _StaticGetType StaticGetType() {
               _StaticGetTypeFunc ??= Torque3D.LookupEngineFunction<_StaticGetType>("fnGuiProgressCtrl_staticGetType");
            ...
            internal static _Create Create() {
               _CreateFunc ??= Torque3D.LookupEngineFunction<_Create>("fnGuiProgressCtrl_create");
