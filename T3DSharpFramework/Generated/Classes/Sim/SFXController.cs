...
namespace T3DSharpFramework.Generated.Classes.Sim {
    ...
    public class SFXController : SFXSource {
        ...
        new internal struct InternalUnsafeMethods {
            ...
            internal static _SetCurrentSlot SetCurrentSlot() {
               _SetCurrentSlotFunc ??= Torque3D.LookupEngineFunction<_SetCurrentSlot>("fnSFXController_setCurrentSlot");
            ...
            internal static _GetCurrentSlot GetCurrentSlot() {
               _GetCurrentSlotFunc ??= Torque3D.LookupEngineFunction<_GetCurrentSlot>("fnSFXController_getCurrentSlot");
            ...
            internal static _StaticGetType StaticGetType() {
               _StaticGetTypeFunc ??= Torque3D.LookupEngineFunction<_StaticGetType>("fnSFXController_staticGetType");
            ...
            internal static _Create Create() {
               _CreateFunc ??= Torque3D.LookupEngineFunction<_Create>("fnSFXController_create");
