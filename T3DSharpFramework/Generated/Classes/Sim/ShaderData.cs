...
namespace T3DSharpFramework.Generated.Classes.Sim {
    ...
    /// </code>
    public class ShaderData : SimObject {
        ...
        new internal struct InternalUnsafeMethods {
            ...
            internal static _Reload Reload() {
               _ReloadFunc ??= Torque3D.LookupEngineFunction<_Reload>("fnShaderData_reload");
            ...
            internal static _StaticGetType StaticGetType() {
               _StaticGetTypeFunc ??= Torque3D.LookupEngineFunction<_StaticGetType>("fnShaderData_staticGetType");
            ...
            internal static _Create Create() {
               _CreateFunc ??= Torque3D.LookupEngineFunction<_Create>("fnShaderData_create");
