...
namespace T3DSharpFramework.Generated.Classes.Sim {
    ...
    public class FileStreamObject : StreamObject {
        ...
        new internal struct InternalUnsafeMethods {
            ...
            internal static _Close Close() {
               _CloseFunc ??= Torque3D.LookupEngineFunction<_Close>("fnFileStreamObject_close");
            ...
            internal static _Open Open() {
               _OpenFunc ??= Torque3D.LookupEngineFunction<_Open>("fnFileStreamObject_open");
            ...
            internal static _StaticGetType StaticGetType() {
               _StaticGetTypeFunc ??= Torque3D.LookupEngineFunction<_StaticGetType>("fnFileStreamObject_staticGetType");
            ...
            internal static _Create Create() {
               _CreateFunc ??= Torque3D.LookupEngineFunction<_Create>("fnFileStreamObject_create");
