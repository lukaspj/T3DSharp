...
namespace T3DSharpFramework.Generated.Classes.Sim {
    ...
    public class TurretShapeData : ItemData {
        ...
        new internal struct InternalUnsafeMethods {
            ...
            internal static _OnStickyCollision OnStickyCollision() {
               _OnStickyCollisionFunc ??= Torque3D.LookupEngineFunction<_OnStickyCollision>("cbTurretShapeData_onStickyCollision");
            ...
            internal static _OnUnmountObject OnUnmountObject() {
               _OnUnmountObjectFunc ??= Torque3D.LookupEngineFunction<_OnUnmountObject>("cbTurretShapeData_onUnmountObject");
            ...
            internal static _OnMountObject OnMountObject() {
               _OnMountObjectFunc ??= Torque3D.LookupEngineFunction<_OnMountObject>("cbTurretShapeData_onMountObject");
            ...
            internal static _StaticGetType StaticGetType() {
               _StaticGetTypeFunc ??= Torque3D.LookupEngineFunction<_StaticGetType>("fnTurretShapeData_staticGetType");
            ...
            internal static _Create Create() {
               _CreateFunc ??= Torque3D.LookupEngineFunction<_Create>("fnTurretShapeData_create");
