...
namespace T3DSharpFramework.Generated.Classes.Sim {
    ...
    /// </description>
    public class afxAnimLockData : GameBaseData {
        ...
        new internal struct InternalUnsafeMethods {
            ...
            internal static _StaticGetType StaticGetType() {
               _StaticGetTypeFunc ??= Torque3D.LookupEngineFunction<_StaticGetType>("fnafxAnimLockData_staticGetType");
            ...
            internal static _Create Create() {
               _CreateFunc ??= Torque3D.LookupEngineFunction<_Create>("fnafxAnimLockData_create");
