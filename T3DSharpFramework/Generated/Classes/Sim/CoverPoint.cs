...
namespace T3DSharpFramework.Generated.Classes.Sim {
    ...
    /// 
    /// </description>
    public class CoverPoint : SceneObject {
        ...
        new internal struct InternalUnsafeMethods {
            ...
            internal static _IsOccupied IsOccupied() {
               _IsOccupiedFunc ??= Torque3D.LookupEngineFunction<_IsOccupied>("fnCoverPoint_isOccupied");
            ...
            internal static _StaticGetType StaticGetType() {
               _StaticGetTypeFunc ??= Torque3D.LookupEngineFunction<_StaticGetType>("fnCoverPoint_staticGetType");
            ...
            internal static _Create Create() {
               _CreateFunc ??= Torque3D.LookupEngineFunction<_Create>("fnCoverPoint_create");
