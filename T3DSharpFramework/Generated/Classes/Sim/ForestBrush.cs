...
namespace T3DSharpFramework.Generated.Classes.Sim {
    ...
    /// Editor use only.
    /// </description>
    public class ForestBrush : SimGroup {
        ...
        new internal struct InternalUnsafeMethods {
            ...
            internal static _ContainsItemData ContainsItemData() {
               _ContainsItemDataFunc ??= Torque3D.LookupEngineFunction<_ContainsItemData>("fnForestBrush_containsItemData");
            ...
            internal static _StaticGetType StaticGetType() {
               _StaticGetTypeFunc ??= Torque3D.LookupEngineFunction<_StaticGetType>("fnForestBrush_staticGetType");
            ...
            internal static _Create Create() {
               _CreateFunc ??= Torque3D.LookupEngineFunction<_Create>("fnForestBrush_create");
