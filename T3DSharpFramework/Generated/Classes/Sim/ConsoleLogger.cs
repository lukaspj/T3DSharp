...
namespace T3DSharpFramework.Generated.Classes.Sim {
    ...
    public class ConsoleLogger : SimObject {
        ...
        new internal struct InternalUnsafeMethods {
            ...
            internal static _Detach Detach() {
               _DetachFunc ??= Torque3D.LookupEngineFunction<_Detach>("fnConsoleLogger_detach");
            ...
            internal static _Attach Attach() {
               _AttachFunc ??= Torque3D.LookupEngineFunction<_Attach>("fnConsoleLogger_attach");
            ...
            internal static _StaticGetType StaticGetType() {
               _StaticGetTypeFunc ??= Torque3D.LookupEngineFunction<_StaticGetType>("fnConsoleLogger_staticGetType");
            ...
            internal static _Create Create() {
               _CreateFunc ??= Torque3D.LookupEngineFunction<_Create>("fnConsoleLogger_create");
