...
namespace T3DSharpFramework.Generated.Classes.Sim {
    ...
    public class ParticleEmitter : GameBase {
        ...
        new internal struct InternalUnsafeMethods {
            ...
            internal static _StaticGetType StaticGetType() {
               _StaticGetTypeFunc ??= Torque3D.LookupEngineFunction<_StaticGetType>("fnParticleEmitter_staticGetType");
            ...
            internal static _Create Create() {
               _CreateFunc ??= Torque3D.LookupEngineFunction<_Create>("fnParticleEmitter_create");
