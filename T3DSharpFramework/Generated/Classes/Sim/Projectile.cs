    ...
    public class Projectile : GameBase {
        ...
        new internal struct InternalUnsafeMethods {
            ...
            internal static _Presimulate Presimulate() {
               _PresimulateFunc ??= Torque3D.LookupEngineFunction<_Presimulate>("fnProjectile_presimulate");
            ...
            internal static _StaticGetType StaticGetType() {
               _StaticGetTypeFunc ??= Torque3D.LookupEngineFunction<_StaticGetType>("fnProjectile_staticGetType");
            ...
            internal static _Create Create() {
               _CreateFunc ??= Torque3D.LookupEngineFunction<_Create>("fnProjectile_create");
