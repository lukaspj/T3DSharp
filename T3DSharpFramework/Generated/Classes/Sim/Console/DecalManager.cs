...
namespace T3DSharpFramework.Generated.Classes.Sim.Console {
    ...
    /// </description>
    /// <see cref="Decals" />
    public class DecalManager : SceneObject {
        ...
        new internal struct InternalUnsafeMethods {
            ...
            internal static _StaticGetType StaticGetType() {
               _StaticGetTypeFunc ??= Torque3D.LookupEngineFunction<_StaticGetType>("fnDecalManager_staticGetType");
            ...
            internal static _Create Create() {
               _CreateFunc ??= Torque3D.LookupEngineFunction<_Create>("fnDecalManager_create");
