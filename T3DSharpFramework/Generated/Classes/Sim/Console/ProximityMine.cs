    ...
    public class ProximityMine : Item {
        ...
        new internal struct InternalUnsafeMethods {
            ...
            internal static _Explode Explode() {
               _ExplodeFunc ??= Torque3D.LookupEngineFunction<_Explode>("fnProximityMine_explode");
            ...
            internal static _StaticGetType StaticGetType() {
               _StaticGetTypeFunc ??= Torque3D.LookupEngineFunction<_StaticGetType>("fnProximityMine_staticGetType");
            ...
            internal static _Create Create() {
               _CreateFunc ??= Torque3D.LookupEngineFunction<_Create>("fnProximityMine_create");
