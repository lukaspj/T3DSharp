...
namespace T3DSharpFramework.Generated.Classes.Sim.Console {
    ...
    /// };
    /// </code>
    public class PhysicalZone : SceneObject {
        ...
        new internal struct InternalUnsafeMethods {
            ...
            internal static _Deactivate Deactivate() {
               _DeactivateFunc ??= Torque3D.LookupEngineFunction<_Deactivate>("fnPhysicalZone_deactivate");
            ...
            internal static _Activate Activate() {
               _ActivateFunc ??= Torque3D.LookupEngineFunction<_Activate>("fnPhysicalZone_activate");
            ...
            internal static _StaticGetType StaticGetType() {
               _StaticGetTypeFunc ??= Torque3D.LookupEngineFunction<_StaticGetType>("fnPhysicalZone_staticGetType");
            ...
            internal static _Create Create() {
               _CreateFunc ??= Torque3D.LookupEngineFunction<_Create>("fnPhysicalZone_create");
