...
namespace T3DSharpFramework.Generated.Classes.Sim.Console {
    ...
    /// </code>
    /// <see cref="LightBase" />
    public class LightDescription : SimDataBlock {
        ...
        new internal struct InternalUnsafeMethods {
            ...
            internal static _Apply Apply() {
               _ApplyFunc ??= Torque3D.LookupEngineFunction<_Apply>("fnLightDescription_apply");
            ...
            internal static _StaticGetType StaticGetType() {
               _StaticGetTypeFunc ??= Torque3D.LookupEngineFunction<_StaticGetType>("fnLightDescription_staticGetType");
            ...
            internal static _Create Create() {
               _CreateFunc ??= Torque3D.LookupEngineFunction<_Create>("fnLightDescription_create");
