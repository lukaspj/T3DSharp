...
namespace T3DSharpFramework.Generated.Classes.Sim.Console {
    ...
    /// </code>
    /// <see cref="GuiControl" />
    public class GuiObjectView : GuiTSCtrl {
        ...
        new internal struct InternalUnsafeMethods {
            ...
            internal static _SetLightDirection SetLightDirection() {
               _SetLightDirectionFunc ??= Torque3D.LookupEngineFunction<_SetLightDirection>("fnGuiObjectView_setLightDirection");
            ...
            internal static _SetLightAmbient SetLightAmbient() {
               _SetLightAmbientFunc ??= Torque3D.LookupEngineFunction<_SetLightAmbient>("fnGuiObjectView_setLightAmbient");
            ...
            internal static _SetLightColor SetLightColor() {
               _SetLightColorFunc ??= Torque3D.LookupEngineFunction<_SetLightColor>("fnGuiObjectView_setLightColor");
            ...
            internal static _SetCameraSpeed SetCameraSpeed() {
               _SetCameraSpeedFunc ??= Torque3D.LookupEngineFunction<_SetCameraSpeed>("fnGuiObjectView_setCameraSpeed");
            ...
            internal static _GetCameraSpeed GetCameraSpeed() {
               _GetCameraSpeedFunc ??= Torque3D.LookupEngineFunction<_GetCameraSpeed>("fnGuiObjectView_getCameraSpeed");
            ...
            internal static _SetOrbitDistance SetOrbitDistance() {
               _SetOrbitDistanceFunc ??= Torque3D.LookupEngineFunction<_SetOrbitDistance>("fnGuiObjectView_setOrbitDistance");
            ...
            internal static _GetOrbitDistance GetOrbitDistance() {
               _GetOrbitDistanceFunc ??= Torque3D.LookupEngineFunction<_GetOrbitDistance>("fnGuiObjectView_getOrbitDistance");
            ...
            internal static _SetMount SetMount() {
               _SetMountFunc ??= Torque3D.LookupEngineFunction<_SetMount>("fnGuiObjectView_setMount");
            ...
            internal static _SetSeq SetSeq() {
               _SetSeqFunc ??= Torque3D.LookupEngineFunction<_SetSeq>("fnGuiObjectView_setSeq");
            ...
            internal static _SetMountSkin SetMountSkin() {
               _SetMountSkinFunc ??= Torque3D.LookupEngineFunction<_SetMountSkin>("fnGuiObjectView_setMountSkin");
            ...
            internal static _GetMountSkin GetMountSkin() {
               _GetMountSkinFunc ??= Torque3D.LookupEngineFunction<_GetMountSkin>("fnGuiObjectView_getMountSkin");
            ...
            internal static _SetSkin SetSkin() {
               _SetSkinFunc ??= Torque3D.LookupEngineFunction<_SetSkin>("fnGuiObjectView_setSkin");
            ...
            internal static _GetSkin GetSkin() {
               _GetSkinFunc ??= Torque3D.LookupEngineFunction<_GetSkin>("fnGuiObjectView_getSkin");
            ...
            internal static _SetMountedModel SetMountedModel() {
               _SetMountedModelFunc ??= Torque3D.LookupEngineFunction<_SetMountedModel>("fnGuiObjectView_setMountedModel");
            ...
            internal static _GetMountedModel GetMountedModel() {
               _GetMountedModelFunc ??= Torque3D.LookupEngineFunction<_GetMountedModel>("fnGuiObjectView_getMountedModel");
            ...
            internal static _SetModel SetModel() {
               _SetModelFunc ??= Torque3D.LookupEngineFunction<_SetModel>("fnGuiObjectView_setModel");
            ...
            internal static _GetModel GetModel() {
               _GetModelFunc ??= Torque3D.LookupEngineFunction<_GetModel>("fnGuiObjectView_getModel");
            ...
            internal static _OnMouseLeave OnMouseLeave() {
               _OnMouseLeaveFunc ??= Torque3D.LookupEngineFunction<_OnMouseLeave>("cbGuiObjectView_onMouseLeave");
            ...
            internal static _OnMouseEnter OnMouseEnter() {
               _OnMouseEnterFunc ??= Torque3D.LookupEngineFunction<_OnMouseEnter>("cbGuiObjectView_onMouseEnter");
            ...
            internal static _StaticGetType StaticGetType() {
               _StaticGetTypeFunc ??= Torque3D.LookupEngineFunction<_StaticGetType>("fnGuiObjectView_staticGetType");
            ...
            internal static _Create Create() {
               _CreateFunc ??= Torque3D.LookupEngineFunction<_Create>("fnGuiObjectView_create");
