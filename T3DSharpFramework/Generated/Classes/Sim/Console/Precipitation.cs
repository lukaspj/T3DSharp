...
namespace T3DSharpFramework.Generated.Classes.Sim.Console {
    ...
    public class Precipitation : GameBase {
        ...
        new internal struct InternalUnsafeMethods {
            ...
            internal static _SetTurbulence SetTurbulence() {
               _SetTurbulenceFunc ??= Torque3D.LookupEngineFunction<_SetTurbulence>("fnPrecipitation_setTurbulence");
            ...
            internal static _ModifyStorm ModifyStorm() {
               _ModifyStormFunc ??= Torque3D.LookupEngineFunction<_ModifyStorm>("fnPrecipitation_modifyStorm");
            ...
            internal static _SetPercentage SetPercentage() {
               _SetPercentageFunc ??= Torque3D.LookupEngineFunction<_SetPercentage>("fnPrecipitation_setPercentage");
            ...
            internal static _StaticGetType StaticGetType() {
               _StaticGetTypeFunc ??= Torque3D.LookupEngineFunction<_StaticGetType>("fnPrecipitation_staticGetType");
            ...
            internal static _Create Create() {
               _CreateFunc ??= Torque3D.LookupEngineFunction<_Create>("fnPrecipitation_create");
