...
namespace T3DSharpFramework.Generated.Classes.Sim.Console {
    ...
    public class ParticleEmitterData : GameBaseData {
        ...
        new internal struct InternalUnsafeMethods {
            ...
            internal static _Reload Reload() {
               _ReloadFunc ??= Torque3D.LookupEngineFunction<_Reload>("fnParticleEmitterData_reload");
            ...
            internal static _StaticGetType StaticGetType() {
               _StaticGetTypeFunc ??= Torque3D.LookupEngineFunction<_StaticGetType>("fnParticleEmitterData_staticGetType");
            ...
            internal static _Create Create() {
               _CreateFunc ??= Torque3D.LookupEngineFunction<_Create>("fnParticleEmitterData_create");
        ...
        /// </description>
        /// </value>
        public float ThetaVariance {
            get => GenericMarshal.StringTo<float>(GetFieldValue("thetaVariance"));
            set => SetFieldValue("thetaVariance", GenericMarshal.ToString(value));
        }
        ...
        /// </description>
        /// </value>
        public bool RibbonParticles {
            get => GenericMarshal.StringTo<bool>(GetFieldValue("ribbonParticles"));
            set => SetFieldValue("ribbonParticles", GenericMarshal.ToString(value));
        }
