...
namespace T3DSharpFramework.Generated.Classes.Sim.Console {
    ...
    public class FileDialog : SimObject {
        ...
        new internal struct InternalUnsafeMethods {
            ...
            internal static _Execute Execute() {
               _ExecuteFunc ??= Torque3D.LookupEngineFunction<_Execute>("fnFileDialog_Execute");
            ...
            internal static _StaticGetType StaticGetType() {
               _StaticGetTypeFunc ??= Torque3D.LookupEngineFunction<_StaticGetType>("fnFileDialog_staticGetType");
            ...
            internal static _Create Create() {
               _CreateFunc ??= Torque3D.LookupEngineFunction<_Create>("fnFileDialog_create");
