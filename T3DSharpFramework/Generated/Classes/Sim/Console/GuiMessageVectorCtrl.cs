...
namespace T3DSharpFramework.Generated.Classes.Sim.Console {
    ...
    public class GuiMessageVectorCtrl : GuiControl {
        ...
        new internal struct InternalUnsafeMethods {
            ...
            internal static _Detach Detach() {
               _DetachFunc ??= Torque3D.LookupEngineFunction<_Detach>("fnGuiMessageVectorCtrl_detach");
            ...
            internal static _Attach Attach() {
               _AttachFunc ??= Torque3D.LookupEngineFunction<_Attach>("fnGuiMessageVectorCtrl_attach");
            ...
            internal static _StaticGetType StaticGetType() {
               _StaticGetTypeFunc ??= Torque3D.LookupEngineFunction<_StaticGetType>("fnGuiMessageVectorCtrl_staticGetType");
            ...
            internal static _Create Create() {
               _CreateFunc ??= Torque3D.LookupEngineFunction<_Create>("fnGuiMessageVectorCtrl_create");
