...
namespace T3DSharpFramework.Generated.Classes.Sim.Console {
    ...
    public class Lightning : GameBase {
        ...
        new internal struct InternalUnsafeMethods {
            ...
            internal static _StrikeObject StrikeObject() {
               _StrikeObjectFunc ??= Torque3D.LookupEngineFunction<_StrikeObject>("fnLightning_strikeObject");
            ...
            internal static _StrikeRandomPoint StrikeRandomPoint() {
               _StrikeRandomPointFunc ??= Torque3D.LookupEngineFunction<_StrikeRandomPoint>("fnLightning_strikeRandomPoint");
            ...
            internal static _WarningFlashes WarningFlashes() {
               _WarningFlashesFunc ??= Torque3D.LookupEngineFunction<_WarningFlashes>("fnLightning_warningFlashes");
            ...
            internal static _ApplyDamage ApplyDamage() {
               _ApplyDamageFunc ??= Torque3D.LookupEngineFunction<_ApplyDamage>("cbLightning_applyDamage");
            ...
            internal static _StaticGetType StaticGetType() {
               _StaticGetTypeFunc ??= Torque3D.LookupEngineFunction<_StaticGetType>("fnLightning_staticGetType");
            ...
            internal static _Create Create() {
               _CreateFunc ??= Torque3D.LookupEngineFunction<_Create>("fnLightning_create");
