...
namespace T3DSharpFramework.Generated.Classes.Sim.Console {
    ...
    /// </description>
    /// <see cref="GameBase" />
    public class GameBaseData : SimDataBlock {
        ...
        new internal struct InternalUnsafeMethods {
            ...
            internal static _OnUnmount OnUnmount() {
               _OnUnmountFunc ??= Torque3D.LookupEngineFunction<_OnUnmount>("cbGameBaseData_onUnmount");
            ...
            internal static _OnMount OnMount() {
               _OnMountFunc ??= Torque3D.LookupEngineFunction<_OnMount>("cbGameBaseData_onMount");
            ...
            internal static _OnRemove OnRemove() {
               _OnRemoveFunc ??= Torque3D.LookupEngineFunction<_OnRemove>("cbGameBaseData_onRemove");
            ...
            internal static _OnNewDataBlock OnNewDataBlock() {
               _OnNewDataBlockFunc ??= Torque3D.LookupEngineFunction<_OnNewDataBlock>("cbGameBaseData_onNewDataBlock");
            ...
            internal static _OnAdd OnAdd() {
               _OnAddFunc ??= Torque3D.LookupEngineFunction<_OnAdd>("cbGameBaseData_onAdd");
            ...
            internal static _StaticGetType StaticGetType() {
               _StaticGetTypeFunc ??= Torque3D.LookupEngineFunction<_StaticGetType>("fnGameBaseData_staticGetType");
            ...
            internal static _Create Create() {
               _CreateFunc ??= Torque3D.LookupEngineFunction<_Create>("fnGameBaseData_create");
