...
namespace T3DSharpFramework.Generated.Classes.Sim.Console {
    ...
    public class ParticleData : SimDataBlock {
        ...
        new internal struct InternalUnsafeMethods {
            ...
            internal delegate bool _SetTexture(IntPtr _this, SetTexture__Args args);
            private static _SetTexture _SetTextureFunc;
            internal static _SetTexture SetTexture() {
               _SetTextureFunc ??= Torque3D.LookupEngineFunction<_SetTexture>("fnParticleData_setTexture");
            ...
            [StructLayout(LayoutKind.Sequential)]
            internal struct GetTextureAsset__Args
            {
            }

            [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
            
            internal delegate IntPtr _GetTextureAsset(IntPtr _this, GetTextureAsset__Args args);
            private static _GetTextureAsset _GetTextureAssetFunc;
            internal static _GetTextureAsset GetTextureAsset() {
               _GetTextureAssetFunc ??= Torque3D.LookupEngineFunction<_GetTextureAsset>("fnParticleData_getTextureAsset");

                return _GetTextureAssetFunc;
            }


            [StructLayout(LayoutKind.Sequential)]
            internal struct GetTexture__Args
            {
            }

            [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
            
            internal delegate IntPtr _GetTexture(IntPtr _this, GetTexture__Args args);
            private static _GetTexture _GetTextureFunc;
            internal static _GetTexture GetTexture() {
               _GetTextureFunc ??= Torque3D.LookupEngineFunction<_GetTexture>("fnParticleData_getTexture");

                return _GetTextureFunc;
            }
            ...
            internal static _Reload Reload() {
               _ReloadFunc ??= Torque3D.LookupEngineFunction<_Reload>("fnParticleData_reload");
            ...
            internal static _StaticGetType StaticGetType() {
               _StaticGetTypeFunc ??= Torque3D.LookupEngineFunction<_StaticGetType>("fnParticleData_staticGetType");
            ...
            internal static _Create Create() {
               _CreateFunc ??= Torque3D.LookupEngineFunction<_Create>("fnParticleData_create");
        ...
        /// <description>
        /// Textureassignment. first tries asset then flat file.
        /// </description>
        public bool SetTexture(string assetName) {
             InternalUnsafeMethods.SetTexture__Args _args = new InternalUnsafeMethods.SetTexture__Args() {
                assetName = assetName,
             };
             bool _engineResult = InternalUnsafeMethods.SetTexture()(ObjectPtr, _args);
             return _engineResult;
        }

        /// <description>
        /// Textureasset reference
        /// </description>
        public string GetTextureAsset() {
             InternalUnsafeMethods.GetTextureAsset__Args _args = new InternalUnsafeMethods.GetTextureAsset__Args() {
             };
             IntPtr _engineResult = InternalUnsafeMethods.GetTextureAsset()(ObjectPtr, _args);
        ...
        public string GetTexture() {
             InternalUnsafeMethods.GetTexture__Args _args = new InternalUnsafeMethods.GetTexture__Args() {
             };
             IntPtr _engineResult = InternalUnsafeMethods.GetTexture()(ObjectPtr, _args);
             return StringMarshal.IntPtrToUtf8String(_engineResult);
        }
        ...
        /// <value>
        /// <summary>Texture "Texture to use for this particle."</summary>
        /// </value>
        ...
        /// <value>
        /// <summary>Texture asset "Texture to use for this particle.".</summary>
        /// </value>
        ...
        /// <value>
        /// <summary>TextureExt ""</summary>
        /// </value>
        public string TextureExt {
            get => GenericMarshal.StringTo<string>(GetFieldValue("TextureExt"));
            set => SetFieldValue("TextureExt", GenericMarshal.ToString(value));
        }


        /// <value>
        /// <summary>TextureExt asset "".</summary>
        /// </value>
        public string TextureExtAsset {
            get => GenericMarshal.StringTo<string>(GetFieldValue("TextureExtAsset"));
            set => SetFieldValue("TextureExtAsset", GenericMarshal.ToString(value));
        }
