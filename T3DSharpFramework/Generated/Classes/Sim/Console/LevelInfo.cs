...
namespace T3DSharpFramework.Generated.Classes.Sim.Console {
    ...
    /// };
    /// </code>
    public class LevelInfo : NetObject {
        ...
        new internal struct InternalUnsafeMethods {
            ...
            internal static _StaticGetType StaticGetType() {
               _StaticGetTypeFunc ??= Torque3D.LookupEngineFunction<_StaticGetType>("fnLevelInfo_staticGetType");
            ...
            internal static _Create Create() {
               _CreateFunc ??= Torque3D.LookupEngineFunction<_Create>("fnLevelInfo_create");
        ...
        /// <value>
        /// <summary>dampness influence</summary>
        /// </value>
        public float Dampness {
            get => GenericMarshal.StringTo<float>(GetFieldValue("dampness"));
            set => SetFieldValue("dampness", GenericMarshal.ToString(value));
        }
        ...
        /// <value>
        /// <summary>AccuTexture "Accumulation texture."</summary>
        /// </value>
        ...
        /// <value>
        /// <summary>AccuTexture asset "Accumulation texture.".</summary>
        /// </value>
        public string AccuTextureAsset {
            get => GenericMarshal.StringTo<string>(GetFieldValue("AccuTextureAsset"));
            set => SetFieldValue("AccuTextureAsset", GenericMarshal.ToString(value));
        }
