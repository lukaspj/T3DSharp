...
namespace T3DSharpFramework.Generated.Classes.Sim.Console {
    ...
    /// </description>
    public class GuiTickCtrl : GuiControl {
        ...
        new internal struct InternalUnsafeMethods {
            ...
            internal static _SetProcessTicks SetProcessTicks() {
               _SetProcessTicksFunc ??= Torque3D.LookupEngineFunction<_SetProcessTicks>("fnGuiTickCtrl_setProcessTicks");
            ...
            internal static _StaticGetType StaticGetType() {
               _StaticGetTypeFunc ??= Torque3D.LookupEngineFunction<_StaticGetType>("fnGuiTickCtrl_staticGetType");
            ...
            internal static _Create Create() {
               _CreateFunc ??= Torque3D.LookupEngineFunction<_Create>("fnGuiTickCtrl_create");
