...
namespace T3DSharpFramework.Generated.Classes.Sim.Console {
    ...
    /// Editor use only.
    /// </description>
    public class GuiGradientCtrl : GuiControl {
        ...
        new internal struct InternalUnsafeMethods {
            ...
            internal static _GetColor GetColor() {
               _GetColorFunc ??= Torque3D.LookupEngineFunction<_GetColor>("fnGuiGradientCtrl_getColor");
            ...
            internal static _GetColorCount GetColorCount() {
               _GetColorCountFunc ??= Torque3D.LookupEngineFunction<_GetColorCount>("fnGuiGradientCtrl_getColorCount");
            ...
            internal static _StaticGetType StaticGetType() {
               _StaticGetTypeFunc ??= Torque3D.LookupEngineFunction<_StaticGetType>("fnGuiGradientCtrl_staticGetType");
            ...
            internal static _Create Create() {
               _CreateFunc ??= Torque3D.LookupEngineFunction<_Create>("fnGuiGradientCtrl_create");
