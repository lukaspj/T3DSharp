...
namespace T3DSharpFramework.Generated.Classes.Sim.Console {
    ...
    /// %fileRead.delete();
    /// </code>
    public class FileObject : SimObject {
        ...
        new internal struct InternalUnsafeMethods {
            ...
            internal static _WriteObject WriteObject() {
               _WriteObjectFunc ??= Torque3D.LookupEngineFunction<_WriteObject>("fnFileObject_writeObject");
            ...
            internal static _Close Close() {
               _CloseFunc ??= Torque3D.LookupEngineFunction<_Close>("fnFileObject_close");
            ...
            internal static _WriteLine WriteLine() {
               _WriteLineFunc ??= Torque3D.LookupEngineFunction<_WriteLine>("fnFileObject_writeLine");
            ...
            internal static _PeekLine PeekLine() {
               _PeekLineFunc ??= Torque3D.LookupEngineFunction<_PeekLine>("fnFileObject_peekLine");
            ...
            internal static _ReadLine ReadLine() {
               _ReadLineFunc ??= Torque3D.LookupEngineFunction<_ReadLine>("fnFileObject_readLine");
            ...
            internal static _IsEOF IsEOF() {
               _IsEOFFunc ??= Torque3D.LookupEngineFunction<_IsEOF>("fnFileObject_isEOF");
            ...
            internal static _OpenForAppend OpenForAppend() {
               _OpenForAppendFunc ??= Torque3D.LookupEngineFunction<_OpenForAppend>("fnFileObject_openForAppend");
            ...
            internal static _OpenForWrite OpenForWrite() {
               _OpenForWriteFunc ??= Torque3D.LookupEngineFunction<_OpenForWrite>("fnFileObject_openForWrite");
            ...
            internal static _OpenForRead OpenForRead() {
               _OpenForReadFunc ??= Torque3D.LookupEngineFunction<_OpenForRead>("fnFileObject_openForRead");
            ...
            internal static _StaticGetType StaticGetType() {
               _StaticGetTypeFunc ??= Torque3D.LookupEngineFunction<_StaticGetType>("fnFileObject_staticGetType");
            ...
            internal static _Create Create() {
               _CreateFunc ??= Torque3D.LookupEngineFunction<_Create>("fnFileObject_create");
        ...
        public string PeekLine(int peekOffset = 0) {
