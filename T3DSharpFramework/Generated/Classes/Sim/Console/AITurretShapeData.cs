...
namespace T3DSharpFramework.Generated.Classes.Sim.Console {
    ...
    public class AITurretShapeData : TurretShapeData {
        ...
        new internal struct InternalUnsafeMethods {
            ...
            internal static _StaticGetType StaticGetType() {
               _StaticGetTypeFunc ??= Torque3D.LookupEngineFunction<_StaticGetType>("fnAITurretShapeData_staticGetType");
            ...
            internal static _Create Create() {
               _CreateFunc ??= Torque3D.LookupEngineFunction<_Create>("fnAITurretShapeData_create");
