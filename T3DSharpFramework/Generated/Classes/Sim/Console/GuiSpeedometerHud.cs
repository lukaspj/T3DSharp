...
namespace T3DSharpFramework.Generated.Classes.Sim.Console {
    ...
    /// };
    /// </code>
    public class GuiSpeedometerHud : GuiBitmapCtrl {
        ...
        new internal struct InternalUnsafeMethods {
            ...
            internal static _StaticGetType StaticGetType() {
               _StaticGetTypeFunc ??= Torque3D.LookupEngineFunction<_StaticGetType>("fnGuiSpeedometerHud_staticGetType");
            ...
            internal static _Create Create() {
               _CreateFunc ??= Torque3D.LookupEngineFunction<_Create>("fnGuiSpeedometerHud_create");
