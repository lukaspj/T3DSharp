...
namespace T3DSharpFramework.Generated.Classes.Sim.Console {
    ...
    /// };
    /// </code>
    public class GuiScriptNotifyCtrl : GuiControl {
        ...
        new internal struct InternalUnsafeMethods {
            ...
            internal static _OnGainFirstResponder OnGainFirstResponder() {
               _OnGainFirstResponderFunc ??= Torque3D.LookupEngineFunction<_OnGainFirstResponder>("cbGuiScriptNotifyCtrl_onGainFirstResponder");
            ...
            internal static _OnLoseFirstResponder OnLoseFirstResponder() {
               _OnLoseFirstResponderFunc ??= Torque3D.LookupEngineFunction<_OnLoseFirstResponder>("cbGuiScriptNotifyCtrl_onLoseFirstResponder");
            ...
            internal static _OnParentResized OnParentResized() {
               _OnParentResizedFunc ??= Torque3D.LookupEngineFunction<_OnParentResized>("cbGuiScriptNotifyCtrl_onParentResized");
            ...
            internal static _OnChildResized OnChildResized() {
               _OnChildResizedFunc ??= Torque3D.LookupEngineFunction<_OnChildResized>("cbGuiScriptNotifyCtrl_onChildResized");
            ...
            internal static _OnChildRemoved OnChildRemoved() {
               _OnChildRemovedFunc ??= Torque3D.LookupEngineFunction<_OnChildRemoved>("cbGuiScriptNotifyCtrl_onChildRemoved");
            ...
            internal static _OnChildAdded OnChildAdded() {
               _OnChildAddedFunc ??= Torque3D.LookupEngineFunction<_OnChildAdded>("cbGuiScriptNotifyCtrl_onChildAdded");
            ...
            internal static _OnResize OnResize() {
               _OnResizeFunc ??= Torque3D.LookupEngineFunction<_OnResize>("cbGuiScriptNotifyCtrl_onResize");
            ...
            internal static _StaticGetType StaticGetType() {
               _StaticGetTypeFunc ??= Torque3D.LookupEngineFunction<_StaticGetType>("fnGuiScriptNotifyCtrl_staticGetType");
            ...
            internal static _Create Create() {
               _CreateFunc ??= Torque3D.LookupEngineFunction<_Create>("fnGuiScriptNotifyCtrl_create");
