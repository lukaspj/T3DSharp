...
namespace T3DSharpFramework.Generated.Classes.Sim.Console {
    ...
    public class PhysicsDebrisData : GameBaseData {
        ...
        new internal struct InternalUnsafeMethods {
            ...
            internal static _Preload Preload() {
               _PreloadFunc ??= Torque3D.LookupEngineFunction<_Preload>("fnPhysicsDebrisData_preload");
            ...
            internal static _StaticGetType StaticGetType() {
               _StaticGetTypeFunc ??= Torque3D.LookupEngineFunction<_StaticGetType>("fnPhysicsDebrisData_staticGetType");
            ...
            internal static _Create Create() {
               _CreateFunc ??= Torque3D.LookupEngineFunction<_Create>("fnPhysicsDebrisData_create");
