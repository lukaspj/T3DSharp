...
namespace T3DSharpFramework.Generated.Classes.Sim.Console {
    ...
    /// <see cref="PointLight" />
    /// <see cref="SpotLight" />
    public class afxT3DLightBaseData : GameBaseData {
        ...
        new internal struct InternalUnsafeMethods {
            ...
            internal static _StaticGetType StaticGetType() {
               _StaticGetTypeFunc ??= Torque3D.LookupEngineFunction<_StaticGetType>("fnafxT3DLightBaseData_staticGetType");
            ...
            internal static _Create Create() {
               _CreateFunc ??= Torque3D.LookupEngineFunction<_Create>("fnafxT3DLightBaseData_create");
