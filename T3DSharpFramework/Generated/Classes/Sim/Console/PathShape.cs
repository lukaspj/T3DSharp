...
namespace T3DSharpFramework.Generated.Classes.Sim.Console {
    /// 
    public class PathShape : StaticShape {
        ...
        new internal struct InternalUnsafeMethods {
            ...
            internal static _GetState GetState() {
               _GetStateFunc ??= Torque3D.LookupEngineFunction<_GetState>("fnPathShape_getState");
            ...
            internal static _PopFront PopFront() {
               _PopFrontFunc ??= Torque3D.LookupEngineFunction<_PopFront>("fnPathShape_popFront");
            ...
            internal static _PushFront PushFront() {
               _PushFrontFunc ??= Torque3D.LookupEngineFunction<_PushFront>("fnPathShape_pushFront");
            ...
            internal static _PushBack PushBack() {
               _PushBackFunc ??= Torque3D.LookupEngineFunction<_PushBack>("fnPathShape_pushBack");
            ...
            internal static _Reset Reset() {
               _ResetFunc ??= Torque3D.LookupEngineFunction<_Reset>("fnPathShape_reset");
            ...
            internal static _SetState SetState() {
               _SetStateFunc ??= Torque3D.LookupEngineFunction<_SetState>("fnPathShape_setState");
            ...
            internal static _SetTarget SetTarget() {
               _SetTargetFunc ??= Torque3D.LookupEngineFunction<_SetTarget>("fnPathShape_setTarget");
            ...
            internal static _SetPosition SetPosition() {
               _SetPositionFunc ??= Torque3D.LookupEngineFunction<_SetPosition>("fnPathShape_setPosition");
            ...
            internal static _StaticGetType StaticGetType() {
               _StaticGetTypeFunc ??= Torque3D.LookupEngineFunction<_StaticGetType>("fnPathShape_staticGetType");
            ...
            internal static _Create Create() {
               _CreateFunc ??= Torque3D.LookupEngineFunction<_Create>("fnPathShape_create");
...
transform.Free();        }
        ...
        /// </code>
        public void PushBack(TransformF transform = null, float speed = 1f, string type = "Normal", string path = "Linear", string hitCommand = "") {
