...
namespace T3DSharpFramework.Generated.Classes.Sim.Console {
    ...
    /// 
    /// </remarks>
    public class SFXEmitter : SceneObject {
        ...
        new internal struct InternalUnsafeMethods {
            ...
            internal static _GetSource GetSource() {
               _GetSourceFunc ??= Torque3D.LookupEngineFunction<_GetSource>("fnSFXEmitter_getSource");
            ...
            internal static _Stop Stop() {
               _StopFunc ??= Torque3D.LookupEngineFunction<_Stop>("fnSFXEmitter_stop");
            ...
            internal static _Play Play() {
               _PlayFunc ??= Torque3D.LookupEngineFunction<_Play>("fnSFXEmitter_play");
            ...
            internal static _StaticGetType StaticGetType() {
               _StaticGetTypeFunc ??= Torque3D.LookupEngineFunction<_StaticGetType>("fnSFXEmitter_staticGetType");
            ...
            internal static _Create Create() {
               _CreateFunc ??= Torque3D.LookupEngineFunction<_Create>("fnSFXEmitter_create");
