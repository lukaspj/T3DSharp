...
namespace T3DSharpFramework.Generated.Classes.Sim.Console {
    ...
    public class ParticleEmitterNode : GameBase {
        ...
        new internal struct InternalUnsafeMethods {
            ...
            internal static _SetActive SetActive() {
               _SetActiveFunc ??= Torque3D.LookupEngineFunction<_SetActive>("fnParticleEmitterNode_setActive");
            ...
            internal static _SetEmitterDataBlock SetEmitterDataBlock() {
               _SetEmitterDataBlockFunc ??= Torque3D.LookupEngineFunction<_SetEmitterDataBlock>("fnParticleEmitterNode_setEmitterDataBlock");
            ...
            internal static _StaticGetType StaticGetType() {
               _StaticGetTypeFunc ??= Torque3D.LookupEngineFunction<_StaticGetType>("fnParticleEmitterNode_staticGetType");
            ...
            internal static _Create Create() {
               _CreateFunc ??= Torque3D.LookupEngineFunction<_Create>("fnParticleEmitterNode_create");
