...
namespace T3DSharpFramework.Generated.Classes.Sim.Console {
    ...
    /// };
    /// </code>
    public class ProjectileData : GameBaseData {
        ...
        new internal struct InternalUnsafeMethods {
            ...
            internal static _OnCollision OnCollision() {
               _OnCollisionFunc ??= Torque3D.LookupEngineFunction<_OnCollision>("cbProjectileData_onCollision");
            ...
            internal static _OnExplode OnExplode() {
               _OnExplodeFunc ??= Torque3D.LookupEngineFunction<_OnExplode>("cbProjectileData_onExplode");
            ...
            internal static _StaticGetType StaticGetType() {
               _StaticGetTypeFunc ??= Torque3D.LookupEngineFunction<_StaticGetType>("fnProjectileData_staticGetType");
            ...
            internal static _Create Create() {
               _CreateFunc ??= Torque3D.LookupEngineFunction<_Create>("fnProjectileData_create");
...
pos.Free();        }
        ...
        /// ProjectileShape"
        /// </description>
        /// <summary>The model of the projectile.\n\n"</summary>
        /// </value>
        public string ProjectileShapeFile {
            get => GenericMarshal.StringTo<string>(GetFieldValue("ProjectileShapeFile"));
            set => SetFieldValue("ProjectileShapeFile", GenericMarshal.ToString(value));
        }


        /// <value>
        /// <description>
        /// ProjectileShapeasset reference.
        /// </description>
        /// </value>
        public string ProjectileShapeAsset {
            get => GenericMarshal.StringTo<string>(GetFieldValue("ProjectileShapeAsset"));
            set => SetFieldValue("ProjectileShapeAsset", GenericMarshal.ToString(value));
        }
        ...
        /// <value>
        /// <description>
        /// ProjectileSound"The sound for the projectile."
        /// </description>
        /// </value>
        public string ProjectileSoundFile {
            get => GenericMarshal.StringTo<string>(GetFieldValue("ProjectileSoundFile"));
            set => SetFieldValue("ProjectileSoundFile", GenericMarshal.ToString(value));
        }


        /// <value>
        /// <description>
        /// ProjectileSoundasset reference.
        /// </description>
        /// </value>
        public string ProjectileSoundAsset {
            get => GenericMarshal.StringTo<string>(GetFieldValue("ProjectileSoundAsset"));
            set => SetFieldValue("ProjectileSoundAsset", GenericMarshal.ToString(value));
        }
