...
namespace T3DSharpFramework.Generated.Classes.Sim.Console {
    ...
    /// 
    /// </description>
    public class afxRPGMagicSpellData : GameBaseData {
        ...
        new internal struct InternalUnsafeMethods {
            ...
            internal static _StaticGetType StaticGetType() {
               _StaticGetTypeFunc ??= Torque3D.LookupEngineFunction<_StaticGetType>("fnafxRPGMagicSpellData_staticGetType");
            ...
            internal static _Create Create() {
               _CreateFunc ??= Torque3D.LookupEngineFunction<_Create>("fnafxRPGMagicSpellData_create");
