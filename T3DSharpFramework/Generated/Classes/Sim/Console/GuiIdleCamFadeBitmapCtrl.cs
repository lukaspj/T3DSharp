...
namespace T3DSharpFramework.Generated.Classes.Sim.Console {
    ...
    /// </description>
    public class GuiIdleCamFadeBitmapCtrl : GuiBitmapCtrl {
        ...
        new internal struct InternalUnsafeMethods {
            ...
            internal static _FadeOut FadeOut() {
               _FadeOutFunc ??= Torque3D.LookupEngineFunction<_FadeOut>("fnGuiIdleCamFadeBitmapCtrl_fadeOut");
            ...
            internal static _FadeIn FadeIn() {
               _FadeInFunc ??= Torque3D.LookupEngineFunction<_FadeIn>("fnGuiIdleCamFadeBitmapCtrl_fadeIn");
            ...
            internal static _StaticGetType StaticGetType() {
               _StaticGetTypeFunc ??= Torque3D.LookupEngineFunction<_StaticGetType>("fnGuiIdleCamFadeBitmapCtrl_staticGetType");
            ...
            internal static _Create Create() {
               _CreateFunc ??= Torque3D.LookupEngineFunction<_Create>("fnGuiIdleCamFadeBitmapCtrl_create");
