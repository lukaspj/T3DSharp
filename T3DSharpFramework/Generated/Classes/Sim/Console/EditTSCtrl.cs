...
namespace T3DSharpFramework.Generated.Classes.Sim.Console {
    ...
    /// </description>
    public class EditTSCtrl : GuiTSCtrl {
        ...
        new internal struct InternalUnsafeMethods {
            ...
            internal static _IsMiddleMouseDown IsMiddleMouseDown() {
               _IsMiddleMouseDownFunc ??= Torque3D.LookupEngineFunction<_IsMiddleMouseDown>("fnEditTSCtrl_isMiddleMouseDown");
            ...
            internal static _GetGizmo GetGizmo() {
               _GetGizmoFunc ??= Torque3D.LookupEngineFunction<_GetGizmo>("fnEditTSCtrl_getGizmo");
            ...
            internal static _RenderLine RenderLine() {
               _RenderLineFunc ??= Torque3D.LookupEngineFunction<_RenderLine>("fnEditTSCtrl_renderLine");
            ...
            internal static _RenderTriangle RenderTriangle() {
               _RenderTriangleFunc ??= Torque3D.LookupEngineFunction<_RenderTriangle>("fnEditTSCtrl_renderTriangle");
            ...
            internal static _RenderCircle RenderCircle() {
               _RenderCircleFunc ??= Torque3D.LookupEngineFunction<_RenderCircle>("fnEditTSCtrl_renderCircle");
            ...
            internal static _RenderSphere RenderSphere() {
               _RenderSphereFunc ??= Torque3D.LookupEngineFunction<_RenderSphere>("fnEditTSCtrl_renderSphere");
            ...
            internal static _RenderBox RenderBox() {
               _RenderBoxFunc ??= Torque3D.LookupEngineFunction<_RenderBox>("fnEditTSCtrl_renderBox");
            ...
            internal static _SetOrthoFOV SetOrthoFOV() {
               _SetOrthoFOVFunc ??= Torque3D.LookupEngineFunction<_SetOrthoFOV>("fnEditTSCtrl_setOrthoFOV");
            ...
            internal static _GetOrthoFOV GetOrthoFOV() {
               _GetOrthoFOVFunc ??= Torque3D.LookupEngineFunction<_GetOrthoFOV>("fnEditTSCtrl_getOrthoFOV");
            ...
            internal static _SetDisplayType SetDisplayType() {
               _SetDisplayTypeFunc ??= Torque3D.LookupEngineFunction<_SetDisplayType>("fnEditTSCtrl_setDisplayType");
            ...
            internal static _GetDisplayType GetDisplayType() {
               _GetDisplayTypeFunc ??= Torque3D.LookupEngineFunction<_GetDisplayType>("fnEditTSCtrl_getDisplayType");
            ...
            internal static _StaticGetType StaticGetType() {
               _StaticGetTypeFunc ??= Torque3D.LookupEngineFunction<_StaticGetType>("fnEditTSCtrl_staticGetType");
            ...
            internal static _Create Create() {
               _CreateFunc ??= Torque3D.LookupEngineFunction<_Create>("fnEditTSCtrl_create");
