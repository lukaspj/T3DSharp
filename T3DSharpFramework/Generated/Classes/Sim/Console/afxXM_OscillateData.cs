...
namespace T3DSharpFramework.Generated.Classes.Sim.Console {
    ...
    /// 
    /// </description>
    public class afxXM_OscillateData : afxXM_WeightedBaseData {
        ...
        new internal struct InternalUnsafeMethods {
            ...
            internal static _StaticGetType StaticGetType() {
               _StaticGetTypeFunc ??= Torque3D.LookupEngineFunction<_StaticGetType>("fnafxXM_OscillateData_staticGetType");
            ...
            internal static _Create Create() {
               _CreateFunc ??= Torque3D.LookupEngineFunction<_Create>("fnafxXM_OscillateData_create");
