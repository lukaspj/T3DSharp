    ...
    public class Debris : GameBase {
        ...
        new internal struct InternalUnsafeMethods {
            ...
            internal static _Init Init() {
               _InitFunc ??= Torque3D.LookupEngineFunction<_Init>("fnDebris_init");
            ...
            internal static _StaticGetType StaticGetType() {
               _StaticGetTypeFunc ??= Torque3D.LookupEngineFunction<_StaticGetType>("fnDebris_staticGetType");
            ...
            internal static _Create Create() {
               _CreateFunc ??= Torque3D.LookupEngineFunction<_Create>("fnDebris_create");
