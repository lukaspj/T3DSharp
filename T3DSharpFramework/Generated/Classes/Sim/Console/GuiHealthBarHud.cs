...
namespace T3DSharpFramework.Generated.Classes.Sim.Console {
    ...
    /// };
    /// </code>
    public class GuiHealthBarHud : GuiControl {
        ...
        new internal struct InternalUnsafeMethods {
            ...
            internal static _StaticGetType StaticGetType() {
               _StaticGetTypeFunc ??= Torque3D.LookupEngineFunction<_StaticGetType>("fnGuiHealthBarHud_staticGetType");
            ...
            internal static _Create Create() {
               _CreateFunc ??= Torque3D.LookupEngineFunction<_Create>("fnGuiHealthBarHud_create");
