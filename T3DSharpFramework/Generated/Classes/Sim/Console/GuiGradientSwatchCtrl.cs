...
namespace T3DSharpFramework.Generated.Classes.Sim.Console {
    ...
    public class GuiGradientSwatchCtrl : GuiSwatchButtonCtrl {
        ...
        new internal struct InternalUnsafeMethods {
            ...
            internal static _OnDoubleClick OnDoubleClick() {
               _OnDoubleClickFunc ??= Torque3D.LookupEngineFunction<_OnDoubleClick>("cbGuiGradientSwatchCtrl_onDoubleClick");
            ...
            internal static _OnMouseDown OnMouseDown() {
               _OnMouseDownFunc ??= Torque3D.LookupEngineFunction<_OnMouseDown>("cbGuiGradientSwatchCtrl_onMouseDown");
            ...
            internal static _StaticGetType StaticGetType() {
               _StaticGetTypeFunc ??= Torque3D.LookupEngineFunction<_StaticGetType>("fnGuiGradientSwatchCtrl_staticGetType");
            ...
            internal static _Create Create() {
               _CreateFunc ??= Torque3D.LookupEngineFunction<_Create>("fnGuiGradientSwatchCtrl_create");
