...
namespace T3DSharpFramework.Generated.Classes.Sim.Console {
    ...
    /// 
    /// </remarks>
    public class GuiSplitContainer : GuiContainer {
        ...
        new internal struct InternalUnsafeMethods {
            ...
            internal static _SetSplitPoint SetSplitPoint() {
               _SetSplitPointFunc ??= Torque3D.LookupEngineFunction<_SetSplitPoint>("fnGuiSplitContainer_setSplitPoint");
            ...
            internal static _StaticGetType StaticGetType() {
               _StaticGetTypeFunc ??= Torque3D.LookupEngineFunction<_StaticGetType>("fnGuiSplitContainer_staticGetType");
            ...
            internal static _Create Create() {
               _CreateFunc ??= Torque3D.LookupEngineFunction<_Create>("fnGuiSplitContainer_create");
