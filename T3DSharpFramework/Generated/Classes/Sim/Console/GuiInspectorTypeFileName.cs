...
namespace T3DSharpFramework.Generated.Classes.Sim.Console {
    ...
    /// Editor use only.
    /// </description>
    public class GuiInspectorTypeFileName : GuiInspectorField {
        ...
        new internal struct InternalUnsafeMethods {
            ...
            internal static _Apply Apply() {
               _ApplyFunc ??= Torque3D.LookupEngineFunction<_Apply>("fnGuiInspectorTypeFileName_apply");
            ...
            internal static _StaticGetType StaticGetType() {
               _StaticGetTypeFunc ??= Torque3D.LookupEngineFunction<_StaticGetType>("fnGuiInspectorTypeFileName_staticGetType");
            ...
            internal static _Create Create() {
               _CreateFunc ??= Torque3D.LookupEngineFunction<_Create>("fnGuiInspectorTypeFileName_create");
