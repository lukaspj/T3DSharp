...
namespace T3DSharpFramework.Generated.Classes.Sim.Console {
    ...
    public class SFXSource : SimGroup {
        ...
        new internal struct InternalUnsafeMethods {
            ...
            internal static _AddMarker AddMarker() {
               _AddMarkerFunc ??= Torque3D.LookupEngineFunction<_AddMarker>("fnSFXSource_addMarker");
            ...
            internal static _GetParameter GetParameter() {
               _GetParameterFunc ??= Torque3D.LookupEngineFunction<_GetParameter>("fnSFXSource_getParameter");
            ...
            internal static _RemoveParameter RemoveParameter() {
               _RemoveParameterFunc ??= Torque3D.LookupEngineFunction<_RemoveParameter>("fnSFXSource_removeParameter");
            ...
            internal static _AddParameter AddParameter() {
               _AddParameterFunc ??= Torque3D.LookupEngineFunction<_AddParameter>("fnSFXSource_addParameter");
            ...
            internal static _GetParameterCount GetParameterCount() {
               _GetParameterCountFunc ??= Torque3D.LookupEngineFunction<_GetParameterCount>("fnSFXSource_getParameterCount");
            ...
            internal static _SetCone SetCone() {
               _SetConeFunc ??= Torque3D.LookupEngineFunction<_SetCone>("fnSFXSource_setCone");
            ...
            internal static _SetTransform SetTransform() {
               _SetTransformFunc ??= Torque3D.LookupEngineFunction<_SetTransform>("fnSFXSource_setTransform");
            ...
            internal static _SetPitch SetPitch() {
               _SetPitchFunc ??= Torque3D.LookupEngineFunction<_SetPitch>("fnSFXSource_setPitch");
            ...
            internal static _GetPitch GetPitch() {
               _GetPitchFunc ??= Torque3D.LookupEngineFunction<_GetPitch>("fnSFXSource_getPitch");
            ...
            internal static _SetFadeTimes SetFadeTimes() {
               _SetFadeTimesFunc ??= Torque3D.LookupEngineFunction<_SetFadeTimes>("fnSFXSource_setFadeTimes");
            ...
            internal static _GetFadeOutTime GetFadeOutTime() {
               _GetFadeOutTimeFunc ??= Torque3D.LookupEngineFunction<_GetFadeOutTime>("fnSFXSource_getFadeOutTime");
            ...
            internal static _GetFadeInTime GetFadeInTime() {
               _GetFadeInTimeFunc ??= Torque3D.LookupEngineFunction<_GetFadeInTime>("fnSFXSource_getFadeInTime");
            ...
            internal static _GetAttenuatedVolume GetAttenuatedVolume() {
               _GetAttenuatedVolumeFunc ??= Torque3D.LookupEngineFunction<_GetAttenuatedVolume>("fnSFXSource_getAttenuatedVolume");
            ...
            internal static _SetVolume SetVolume() {
               _SetVolumeFunc ??= Torque3D.LookupEngineFunction<_SetVolume>("fnSFXSource_setVolume");
            ...
            internal static _GetVolume GetVolume() {
               _GetVolumeFunc ??= Torque3D.LookupEngineFunction<_GetVolume>("fnSFXSource_getVolume");
            ...
            internal static _GetStatus GetStatus() {
               _GetStatusFunc ??= Torque3D.LookupEngineFunction<_GetStatus>("fnSFXSource_getStatus");
            ...
            internal static _IsStopped IsStopped() {
               _IsStoppedFunc ??= Torque3D.LookupEngineFunction<_IsStopped>("fnSFXSource_isStopped");
            ...
            internal static _IsPaused IsPaused() {
               _IsPausedFunc ??= Torque3D.LookupEngineFunction<_IsPaused>("fnSFXSource_isPaused");
            ...
            internal static _IsPlaying IsPlaying() {
               _IsPlayingFunc ??= Torque3D.LookupEngineFunction<_IsPlaying>("fnSFXSource_isPlaying");
            ...
            internal static _Pause Pause() {
               _PauseFunc ??= Torque3D.LookupEngineFunction<_Pause>("fnSFXSource_pause");
            ...
            internal static _Stop Stop() {
               _StopFunc ??= Torque3D.LookupEngineFunction<_Stop>("fnSFXSource_stop");
            ...
            internal static _Play Play() {
               _PlayFunc ??= Torque3D.LookupEngineFunction<_Play>("fnSFXSource_play");
            ...
            internal static _OnParameterValueChange OnParameterValueChange() {
               _OnParameterValueChangeFunc ??= Torque3D.LookupEngineFunction<_OnParameterValueChange>("cbSFXSource_onParameterValueChange");
            ...
            internal static _OnStatusChange OnStatusChange() {
               _OnStatusChangeFunc ??= Torque3D.LookupEngineFunction<_OnStatusChange>("cbSFXSource_onStatusChange");
            ...
            internal static _StaticGetType StaticGetType() {
               _StaticGetTypeFunc ??= Torque3D.LookupEngineFunction<_StaticGetType>("fnSFXSource_staticGetType");
            ...
            internal static _Create Create() {
               _CreateFunc ??= Torque3D.LookupEngineFunction<_Create>("fnSFXSource_create");
