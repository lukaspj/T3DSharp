...
namespace T3DSharpFramework.Generated.Classes.Sim.Console {
    ...
    /// </description>
    public class afxPhraseEffectData : GameBaseData {
        ...
        new internal struct InternalUnsafeMethods {
            ...
            internal static _PushEffect PushEffect() {
               _PushEffectFunc ??= Torque3D.LookupEngineFunction<_PushEffect>("fnafxPhraseEffectData_pushEffect");
            ...
            internal static _StaticGetType StaticGetType() {
               _StaticGetTypeFunc ??= Torque3D.LookupEngineFunction<_StaticGetType>("fnafxPhraseEffectData_staticGetType");
            ...
            internal static _Create Create() {
               _CreateFunc ??= Torque3D.LookupEngineFunction<_Create>("fnafxPhraseEffectData_create");
