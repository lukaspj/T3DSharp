...
namespace T3DSharpFramework.Generated.Classes.Sim.Console {
    ...
    /// </description>
    public class CloudLayer : SceneObject {
        ...
        new internal struct InternalUnsafeMethods {
            ...
            internal static _StaticGetType StaticGetType() {
               _StaticGetTypeFunc ??= Torque3D.LookupEngineFunction<_StaticGetType>("fnCloudLayer_staticGetType");
            ...
            internal static _Create Create() {
               _CreateFunc ??= Torque3D.LookupEngineFunction<_Create>("fnCloudLayer_create");
        ...
        /// <value>
        /// <summary>Texture "An RGBA texture which should contain normals and opacity (density)."</summary>
        /// </value>
        ...
        /// <value>
        /// <summary>Texture asset "An RGBA texture which should contain normals and opacity (density).".</summary>
        /// </value>
