...
namespace T3DSharpFramework.Generated.Classes.Sim.Console {
    ...
    public class MessageVector : SimObject {
        ...
        new internal struct InternalUnsafeMethods {
            ...
            internal static _GetLineTag GetLineTag() {
               _GetLineTagFunc ??= Torque3D.LookupEngineFunction<_GetLineTag>("fnMessageVector_getLineTag");
            ...
            internal static _GetLineText GetLineText() {
               _GetLineTextFunc ??= Torque3D.LookupEngineFunction<_GetLineText>("fnMessageVector_getLineText");
            ...
            internal static _GetLineIndexByTag GetLineIndexByTag() {
               _GetLineIndexByTagFunc ??= Torque3D.LookupEngineFunction<_GetLineIndexByTag>("fnMessageVector_getLineIndexByTag");
            ...
            internal static _GetLineTextByTag GetLineTextByTag() {
               _GetLineTextByTagFunc ??= Torque3D.LookupEngineFunction<_GetLineTextByTag>("fnMessageVector_getLineTextByTag");
            ...
            internal static _GetNumLines GetNumLines() {
               _GetNumLinesFunc ??= Torque3D.LookupEngineFunction<_GetNumLines>("fnMessageVector_getNumLines");
            ...
            internal static _Dump Dump() {
               _DumpFunc ??= Torque3D.LookupEngineFunction<_Dump>("fnMessageVector_dump");
            ...
            internal static _DeleteLine DeleteLine() {
               _DeleteLineFunc ??= Torque3D.LookupEngineFunction<_DeleteLine>("fnMessageVector_deleteLine");
            ...
            internal static _InsertLine InsertLine() {
               _InsertLineFunc ??= Torque3D.LookupEngineFunction<_InsertLine>("fnMessageVector_insertLine");
            ...
            internal static _PopFrontLine PopFrontLine() {
               _PopFrontLineFunc ??= Torque3D.LookupEngineFunction<_PopFrontLine>("fnMessageVector_popFrontLine");
            ...
            internal static _PushFrontLine PushFrontLine() {
               _PushFrontLineFunc ??= Torque3D.LookupEngineFunction<_PushFrontLine>("fnMessageVector_pushFrontLine");
            ...
            internal static _PopBackLine PopBackLine() {
               _PopBackLineFunc ??= Torque3D.LookupEngineFunction<_PopBackLine>("fnMessageVector_popBackLine");
            ...
            internal static _PushBackLine PushBackLine() {
               _PushBackLineFunc ??= Torque3D.LookupEngineFunction<_PushBackLine>("fnMessageVector_pushBackLine");
            ...
            internal static _Clear Clear() {
               _ClearFunc ??= Torque3D.LookupEngineFunction<_Clear>("fnMessageVector_clear");
            ...
            internal static _StaticGetType StaticGetType() {
               _StaticGetTypeFunc ??= Torque3D.LookupEngineFunction<_StaticGetType>("fnMessageVector_staticGetType");
            ...
            internal static _Create Create() {
               _CreateFunc ??= Torque3D.LookupEngineFunction<_Create>("fnMessageVector_create");
