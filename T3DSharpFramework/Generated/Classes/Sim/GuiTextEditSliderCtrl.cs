...
namespace T3DSharpFramework.Generated.Classes.Sim {
    ...
    public class GuiTextEditSliderCtrl : GuiTextEditCtrl {
        ...
        new internal struct InternalUnsafeMethods {
            ...
            internal static _StaticGetType StaticGetType() {
               _StaticGetTypeFunc ??= Torque3D.LookupEngineFunction<_StaticGetType>("fnGuiTextEditSliderCtrl_staticGetType");
            ...
            internal static _Create Create() {
               _CreateFunc ??= Torque3D.LookupEngineFunction<_Create>("fnGuiTextEditSliderCtrl_create");
