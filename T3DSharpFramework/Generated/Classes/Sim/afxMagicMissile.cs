...
namespace T3DSharpFramework.Generated.Classes.Sim {
    ...
    /// 
    /// </description>
    public class afxMagicMissile : GameBase {
        ...
        new internal struct InternalUnsafeMethods {
            ...
            internal static _SetStartingVelocity SetStartingVelocity() {
               _SetStartingVelocityFunc ??= Torque3D.LookupEngineFunction<_SetStartingVelocity>("fnafxMagicMissile_setStartingVelocity");
            ...
            internal static _SetStartingVelocityVector SetStartingVelocityVector() {
               _SetStartingVelocityVectorFunc ??= Torque3D.LookupEngineFunction<_SetStartingVelocityVector>("fnafxMagicMissile_setStartingVelocityVector");
            ...
            internal static _StaticGetType StaticGetType() {
               _StaticGetTypeFunc ??= Torque3D.LookupEngineFunction<_StaticGetType>("fnafxMagicMissile_staticGetType");
            ...
            internal static _Create Create() {
               _CreateFunc ??= Torque3D.LookupEngineFunction<_Create>("fnafxMagicMissile_create");
