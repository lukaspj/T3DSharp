...
namespace T3DSharpFramework.Generated.Classes.Sim {
    /// 
    public class AssetQuery : SimObject {
        ...
        new internal struct InternalUnsafeMethods {
            ...
            internal static _StaticGetType StaticGetType() {
               _StaticGetTypeFunc ??= Torque3D.LookupEngineFunction<_StaticGetType>("fnAssetQuery_staticGetType");
            ...
            internal static _Create Create() {
               _CreateFunc ??= Torque3D.LookupEngineFunction<_Create>("fnAssetQuery_create");
            ...
            internal static _GetAsset GetAsset() {
               _GetAssetFunc ??= Torque3D.LookupEngineFunction<_GetAsset>("fnAssetQuery_getAsset");
            ...
            internal static _GetCount GetCount() {
               _GetCountFunc ??= Torque3D.LookupEngineFunction<_GetCount>("fnAssetQuery_getCount");
            ...
            internal static _Set Set() {
               _SetFunc ??= Torque3D.LookupEngineFunction<_Set>("fnAssetQuery_set");
            ...
            internal static _Clear Clear() {
               _ClearFunc ??= Torque3D.LookupEngineFunction<_Clear>("fnAssetQuery_clear");
