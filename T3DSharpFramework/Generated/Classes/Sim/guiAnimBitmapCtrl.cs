...
namespace T3DSharpFramework.Generated.Classes.Sim {
    /// 
    public class guiAnimBitmapCtrl : GuiBitmapCtrl {
        ...
        new internal struct InternalUnsafeMethods {
            ...
            internal static _OnFrame OnFrame() {
               _OnFrameFunc ??= Torque3D.LookupEngineFunction<_OnFrame>("cbguiAnimBitmapCtrl_onFrame");
            ...
            internal static _OnCompleted OnCompleted() {
               _OnCompletedFunc ??= Torque3D.LookupEngineFunction<_OnCompleted>("cbguiAnimBitmapCtrl_onCompleted");
            ...
            internal static _OnLoop OnLoop() {
               _OnLoopFunc ??= Torque3D.LookupEngineFunction<_OnLoop>("cbguiAnimBitmapCtrl_onLoop");
            ...
            internal static _StaticGetType StaticGetType() {
               _StaticGetTypeFunc ??= Torque3D.LookupEngineFunction<_StaticGetType>("fnguiAnimBitmapCtrl_staticGetType");
            ...
            internal static _Create Create() {
               _CreateFunc ??= Torque3D.LookupEngineFunction<_Create>("fnguiAnimBitmapCtrl_create");
