...
namespace T3DSharpFramework.Generated.Classes.Sim {
    ...
    /// };
    /// </code>
    public class GuiClockHud : GuiControl {
        ...
        new internal struct InternalUnsafeMethods {
            ...
            internal static _GetTime GetTime() {
               _GetTimeFunc ??= Torque3D.LookupEngineFunction<_GetTime>("fnGuiClockHud_getTime");
            ...
            internal static _SetReverseTime SetReverseTime() {
               _SetReverseTimeFunc ??= Torque3D.LookupEngineFunction<_SetReverseTime>("fnGuiClockHud_setReverseTime");
            ...
            internal static _SetTime SetTime() {
               _SetTimeFunc ??= Torque3D.LookupEngineFunction<_SetTime>("fnGuiClockHud_setTime");
            ...
            internal static _StaticGetType StaticGetType() {
               _StaticGetTypeFunc ??= Torque3D.LookupEngineFunction<_StaticGetType>("fnGuiClockHud_staticGetType");
            ...
            internal static _Create Create() {
               _CreateFunc ??= Torque3D.LookupEngineFunction<_Create>("fnGuiClockHud_create");
