...
namespace T3DSharpFramework.Generated.Classes.Sim {
    ...
    /// 
    /// </description>
    public class afxSpellBookData : GameBaseData {
        ...
        new internal struct InternalUnsafeMethods {
            ...
            internal static _GetCapacity GetCapacity() {
               _GetCapacityFunc ??= Torque3D.LookupEngineFunction<_GetCapacity>("fnafxSpellBookData_getCapacity");
            ...
            internal static _GetPageSlotIndex GetPageSlotIndex() {
               _GetPageSlotIndexFunc ??= Torque3D.LookupEngineFunction<_GetPageSlotIndex>("fnafxSpellBookData_getPageSlotIndex");
            ...
            internal static _StaticGetType StaticGetType() {
               _StaticGetTypeFunc ??= Torque3D.LookupEngineFunction<_StaticGetType>("fnafxSpellBookData_staticGetType");
            ...
            internal static _Create Create() {
               _CreateFunc ??= Torque3D.LookupEngineFunction<_Create>("fnafxSpellBookData_create");
