...
namespace T3DSharpFramework.Generated.Classes.Sim {
    ...
    public class SFXAmbience : SimDataBlock {
        ...
        new internal struct InternalUnsafeMethods {
            ...
            internal static _StaticGetType StaticGetType() {
               _StaticGetTypeFunc ??= Torque3D.LookupEngineFunction<_StaticGetType>("fnSFXAmbience_staticGetType");
            ...
            internal static _Create Create() {
               _CreateFunc ??= Torque3D.LookupEngineFunction<_Create>("fnSFXAmbience_create");
        ...
        /// <value>
        /// <description>
        /// SoundTrack"Sound track to play in the ambience zone."
        /// </description>
        /// </value>
        public string SoundTrackFile {
            get => GenericMarshal.StringTo<string>(GetFieldValue("SoundTrackFile"));
            set => SetFieldValue("SoundTrackFile", GenericMarshal.ToString(value));
        }


        /// <value>
        /// <description>
        /// SoundTrackasset reference.
        /// </description>
        /// </value>
        public string SoundTrackAsset {
            get => GenericMarshal.StringTo<string>(GetFieldValue("SoundTrackAsset"));
            set => SetFieldValue("SoundTrackAsset", GenericMarshal.ToString(value));
        }
