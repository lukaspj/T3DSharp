...
namespace T3DSharpFramework.Generated.Classes.Sim {
    ...
    /// </description>
    public class afxEffectWrapper : SimObject {
        ...
        new internal struct InternalUnsafeMethods {
            ...
            internal static _StaticGetType StaticGetType() {
               _StaticGetTypeFunc ??= Torque3D.LookupEngineFunction<_StaticGetType>("fnafxEffectWrapper_staticGetType");
            ...
            internal static _Create Create() {
               _CreateFunc ??= Torque3D.LookupEngineFunction<_Create>("fnafxEffectWrapper_create");
