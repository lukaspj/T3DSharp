    ...
    public class Portal : Zone {
        ...
        new internal struct InternalUnsafeMethods {
            ...
            internal static _IsExteriorPortal IsExteriorPortal() {
               _IsExteriorPortalFunc ??= Torque3D.LookupEngineFunction<_IsExteriorPortal>("fnPortal_isExteriorPortal");
            ...
            internal static _IsInteriorPortal IsInteriorPortal() {
               _IsInteriorPortalFunc ??= Torque3D.LookupEngineFunction<_IsInteriorPortal>("fnPortal_isInteriorPortal");
            ...
            internal static _StaticGetType StaticGetType() {
               _StaticGetTypeFunc ??= Torque3D.LookupEngineFunction<_StaticGetType>("fnPortal_staticGetType");
            ...
            internal static _Create Create() {
               _CreateFunc ??= Torque3D.LookupEngineFunction<_Create>("fnPortal_create");
