    ...
    public class GameBase : SceneObject {
        ...
        new internal struct InternalUnsafeMethods {
            ...
            internal static _DetachChild DetachChild() {
               _DetachChildFunc ??= Torque3D.LookupEngineFunction<_DetachChild>("fnGameBase_detachChild");
            ...
            internal static _AttachChild AttachChild() {
               _AttachChildFunc ??= Torque3D.LookupEngineFunction<_AttachChild>("fnGameBase_attachChild");
            ...
            internal static _ApplyRadialImpulse ApplyRadialImpulse() {
               _ApplyRadialImpulseFunc ??= Torque3D.LookupEngineFunction<_ApplyRadialImpulse>("fnGameBase_applyRadialImpulse");
            ...
            internal static _ApplyImpulse ApplyImpulse() {
               _ApplyImpulseFunc ??= Torque3D.LookupEngineFunction<_ApplyImpulse>("fnGameBase_applyImpulse");
            ...
            internal static _SetDataBlock SetDataBlock() {
               _SetDataBlockFunc ??= Torque3D.LookupEngineFunction<_SetDataBlock>("fnGameBase_setDataBlock");
            ...
            internal static _GetDataBlock GetDataBlock() {
               _GetDataBlockFunc ??= Torque3D.LookupEngineFunction<_GetDataBlock>("fnGameBase_getDataBlock");
            ...
            internal static _StaticGetType StaticGetType() {
               _StaticGetTypeFunc ??= Torque3D.LookupEngineFunction<_StaticGetType>("fnGameBase_staticGetType");
            ...
            internal static _Create Create() {
               _CreateFunc ??= Torque3D.LookupEngineFunction<_Create>("fnGameBase_create");
            ...
            internal static _SetControl SetControl() {
               _SetControlFunc ??= Torque3D.LookupEngineFunction<_SetControl>("cbGameBase_setControl");
