...
namespace T3DSharpFramework.Generated.Classes.Sim {
    ...
    /// </code>
    public class SFXParameter : SimObject {
        ...
        new internal struct InternalUnsafeMethods {
            ...
            internal static _Reset Reset() {
               _ResetFunc ??= Torque3D.LookupEngineFunction<_Reset>("fnSFXParameter_reset");
            ...
            internal static _GetParameterName GetParameterName() {
               _GetParameterNameFunc ??= Torque3D.LookupEngineFunction<_GetParameterName>("fnSFXParameter_getParameterName");
            ...
            internal static _OnUpdate OnUpdate() {
               _OnUpdateFunc ??= Torque3D.LookupEngineFunction<_OnUpdate>("cbSFXParameter_onUpdate");
            ...
            internal static _StaticGetType StaticGetType() {
               _StaticGetTypeFunc ??= Torque3D.LookupEngineFunction<_StaticGetType>("fnSFXParameter_staticGetType");
            ...
            internal static _Create Create() {
               _CreateFunc ??= Torque3D.LookupEngineFunction<_Create>("fnSFXParameter_create");
