...
namespace T3DSharpFramework.Generated.Classes.Sim {
    ...
    /// <see cref="PointLight" />
    /// <see cref="SpotLight" />
    public class LightBase : SceneObject {
        ...
        new internal struct InternalUnsafeMethods {
            ...
            internal static _PauseAnimation PauseAnimation() {
               _PauseAnimationFunc ??= Torque3D.LookupEngineFunction<_PauseAnimation>("fnLightBase_pauseAnimation");
            ...
            internal static _PlayAnimation PlayAnimation() {
               _PlayAnimationFunc ??= Torque3D.LookupEngineFunction<_PlayAnimation>("fnLightBase_playAnimation");
            ...
            internal static _SetLightEnabled SetLightEnabled() {
               _SetLightEnabledFunc ??= Torque3D.LookupEngineFunction<_SetLightEnabled>("fnLightBase_setLightEnabled");
            ...
            internal static _StaticGetType StaticGetType() {
               _StaticGetTypeFunc ??= Torque3D.LookupEngineFunction<_StaticGetType>("fnLightBase_staticGetType");
            ...
            internal static _Create Create() {
               _CreateFunc ??= Torque3D.LookupEngineFunction<_Create>("fnLightBase_create");
