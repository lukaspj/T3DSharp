...
namespace T3DSharpFramework.Generated.Classes.Sim {
    ...
    /// <see cref="GuiControl" />
    public class GuiMLTextEditCtrl : GuiMLTextCtrl {
        ...
        new internal struct InternalUnsafeMethods {
            ...
            internal static _StaticGetType StaticGetType() {
               _StaticGetTypeFunc ??= Torque3D.LookupEngineFunction<_StaticGetType>("fnGuiMLTextEditCtrl_staticGetType");
            ...
            internal static _Create Create() {
               _CreateFunc ??= Torque3D.LookupEngineFunction<_Create>("fnGuiMLTextEditCtrl_create");
