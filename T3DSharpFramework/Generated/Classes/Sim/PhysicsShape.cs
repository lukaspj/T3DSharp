...
namespace T3DSharpFramework.Generated.Classes.Sim {
    ...
    public class PhysicsShape : GameBase {
        ...
        new internal struct InternalUnsafeMethods {
            ...
            internal static _ApplyForce ApplyForce() {
               _ApplyForceFunc ??= Torque3D.LookupEngineFunction<_ApplyForce>("fnPhysicsShape_applyForce");
            ...
            internal static _ApplyTorque ApplyTorque() {
               _ApplyTorqueFunc ??= Torque3D.LookupEngineFunction<_ApplyTorque>("fnPhysicsShape_applyTorque");
            ...
            internal static _Restore Restore() {
               _RestoreFunc ??= Torque3D.LookupEngineFunction<_Restore>("fnPhysicsShape_restore");
            ...
            internal static _Destroy Destroy() {
               _DestroyFunc ??= Torque3D.LookupEngineFunction<_Destroy>("fnPhysicsShape_destroy");
            ...
            internal static _IsDestroyed IsDestroyed() {
               _IsDestroyedFunc ??= Torque3D.LookupEngineFunction<_IsDestroyed>("fnPhysicsShape_isDestroyed");
            ...
            internal static _StaticGetType StaticGetType() {
               _StaticGetTypeFunc ??= Torque3D.LookupEngineFunction<_StaticGetType>("fnPhysicsShape_staticGetType");
            ...
            internal static _Create Create() {
               _CreateFunc ??= Torque3D.LookupEngineFunction<_Create>("fnPhysicsShape_create");
