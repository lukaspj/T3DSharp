    ...
    public class River : WaterObject {
        ...
        new internal struct InternalUnsafeMethods {
            ...
            internal static _SetMaxDivisionSize SetMaxDivisionSize() {
               _SetMaxDivisionSizeFunc ??= Torque3D.LookupEngineFunction<_SetMaxDivisionSize>("fnRiver_setMaxDivisionSize");
            ...
            internal static _SetNodeDepth SetNodeDepth() {
               _SetNodeDepthFunc ??= Torque3D.LookupEngineFunction<_SetNodeDepth>("fnRiver_setNodeDepth");
            ...
            internal static _SetBatchSize SetBatchSize() {
               _SetBatchSizeFunc ??= Torque3D.LookupEngineFunction<_SetBatchSize>("fnRiver_setBatchSize");
            ...
            internal static _SetMetersPerSegment SetMetersPerSegment() {
               _SetMetersPerSegmentFunc ??= Torque3D.LookupEngineFunction<_SetMetersPerSegment>("fnRiver_setMetersPerSegment");
            ...
            internal static _Regenerate Regenerate() {
               _RegenerateFunc ??= Torque3D.LookupEngineFunction<_Regenerate>("fnRiver_regenerate");
            ...
            internal static _StaticGetType StaticGetType() {
               _StaticGetTypeFunc ??= Torque3D.LookupEngineFunction<_StaticGetType>("fnRiver_staticGetType");
            ...
            internal static _Create Create() {
               _CreateFunc ??= Torque3D.LookupEngineFunction<_Create>("fnRiver_create");
