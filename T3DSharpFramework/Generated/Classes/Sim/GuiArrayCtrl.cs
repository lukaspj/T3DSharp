...
namespace T3DSharpFramework.Generated.Classes.Sim {
    ...
    /// </description>
    public class GuiArrayCtrl : GuiControl {
        ...
        new internal struct InternalUnsafeMethods {
            ...
            internal static _OnCellHighlighted OnCellHighlighted() {
               _OnCellHighlightedFunc ??= Torque3D.LookupEngineFunction<_OnCellHighlighted>("cbGuiArrayCtrl_onCellHighlighted");
            ...
            internal static _OnCellSelected OnCellSelected() {
               _OnCellSelectedFunc ??= Torque3D.LookupEngineFunction<_OnCellSelected>("cbGuiArrayCtrl_onCellSelected");
            ...
            internal static _StaticGetType StaticGetType() {
               _StaticGetTypeFunc ??= Torque3D.LookupEngineFunction<_StaticGetType>("fnGuiArrayCtrl_staticGetType");
            ...
            internal static _Create Create() {
               _CreateFunc ??= Torque3D.LookupEngineFunction<_Create>("fnGuiArrayCtrl_create");
