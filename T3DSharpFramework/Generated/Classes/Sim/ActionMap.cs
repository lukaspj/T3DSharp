...
namespace T3DSharpFramework.Generated.Classes.Sim {
    ...
    /// carMap.push();
    /// </code>
    public class ActionMap : SimObject {
        ...
        new internal struct InternalUnsafeMethods {
            ...
            internal static _GetDeadZone GetDeadZone() {
               _GetDeadZoneFunc ??= Torque3D.LookupEngineFunction<_GetDeadZone>("fnActionMap_getDeadZone");
            ...
            internal static _GetScale GetScale() {
               _GetScaleFunc ??= Torque3D.LookupEngineFunction<_GetScale>("fnActionMap_getScale");
            ...
            internal static _IsInverted IsInverted() {
               _IsInvertedFunc ??= Torque3D.LookupEngineFunction<_IsInverted>("fnActionMap_isInverted");
            ...
            internal static _GetCommand GetCommand() {
               _GetCommandFunc ??= Torque3D.LookupEngineFunction<_GetCommand>("fnActionMap_getCommand");
            ...
            internal static _GetBinding GetBinding() {
               _GetBindingFunc ??= Torque3D.LookupEngineFunction<_GetBinding>("fnActionMap_getBinding");
            ...
            internal static _Pop Pop() {
               _PopFunc ??= Torque3D.LookupEngineFunction<_Pop>("fnActionMap_pop");
            ...
            internal static _Push Push() {
               _PushFunc ??= Torque3D.LookupEngineFunction<_Push>("fnActionMap_push");
            ...
            internal static _Save Save() {
               _SaveFunc ??= Torque3D.LookupEngineFunction<_Save>("fnActionMap_save");
            ...
            internal static _UnbindObj UnbindObj() {
               _UnbindObjFunc ??= Torque3D.LookupEngineFunction<_UnbindObj>("fnActionMap_unbindObj");
            ...
            internal static _Unbind Unbind() {
               _UnbindFunc ??= Torque3D.LookupEngineFunction<_Unbind>("fnActionMap_unbind");
            ...
            internal static _BindHold BindHold() {
               _BindHoldFunc ??= Torque3D.LookupEngineFunction<_BindHold>("fnActionMap_bindHold");
            ...
            internal static _BindContext BindContext() {
               _BindContextFunc ??= Torque3D.LookupEngineFunction<_BindContext>("fnActionMap_bindContext");
            ...
            internal static _BindCmd BindCmd() {
               _BindCmdFunc ??= Torque3D.LookupEngineFunction<_BindCmd>("fnActionMap_bindCmd");
            ...
            internal static _BindObj BindObj() {
               _BindObjFunc ??= Torque3D.LookupEngineFunction<_BindObj>("fnActionMap_bindObj");
            ...
            internal static _Bind Bind() {
               _BindFunc ??= Torque3D.LookupEngineFunction<_Bind>("fnActionMap_bind");
            ...
            internal static _StaticGetType StaticGetType() {
               _StaticGetTypeFunc ??= Torque3D.LookupEngineFunction<_StaticGetType>("fnActionMap_staticGetType");
            ...
            internal static _Create Create() {
               _CreateFunc ??= Torque3D.LookupEngineFunction<_Create>("fnActionMap_create");
        ...
        /// <code>
        /// // Write out the actionmap into the config.tscript file
        /// moveMap.save( "scripts/client/config.tscript" );
        /// </code>
