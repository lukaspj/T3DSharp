...
namespace T3DSharpFramework.Generated.Classes.Sim {
    /// 
    public class NavMesh : SceneObject {
        ...
        new internal struct InternalUnsafeMethods {
            ...
            internal static _Save Save() {
               _SaveFunc ??= Torque3D.LookupEngineFunction<_Save>("fnNavMesh_save");
            ...
            internal static _Load Load() {
               _LoadFunc ??= Torque3D.LookupEngineFunction<_Load>("fnNavMesh_load");
            ...
            internal static _CreateCoverPoints CreateCoverPoints() {
               _CreateCoverPointsFunc ??= Torque3D.LookupEngineFunction<_CreateCoverPoints>("fnNavMesh_createCoverPoints");
            ...
            internal static _DeleteCoverPoints DeleteCoverPoints() {
               _DeleteCoverPointsFunc ??= Torque3D.LookupEngineFunction<_DeleteCoverPoints>("fnNavMesh_deleteCoverPoints");
            ...
            internal static _BuildLinks BuildLinks() {
               _BuildLinksFunc ??= Torque3D.LookupEngineFunction<_BuildLinks>("fnNavMesh_buildLinks");
            ...
            internal static _BuildTiles BuildTiles() {
               _BuildTilesFunc ??= Torque3D.LookupEngineFunction<_BuildTiles>("fnNavMesh_buildTiles");
            ...
            internal static _CancelBuild CancelBuild() {
               _CancelBuildFunc ??= Torque3D.LookupEngineFunction<_CancelBuild>("fnNavMesh_cancelBuild");
            ...
            internal static _Build Build() {
               _BuildFunc ??= Torque3D.LookupEngineFunction<_Build>("fnNavMesh_build");
            ...
            internal static _DeleteLinks DeleteLinks() {
               _DeleteLinksFunc ??= Torque3D.LookupEngineFunction<_DeleteLinks>("fnNavMesh_deleteLinks");
            ...
            internal static _DeleteLink DeleteLink() {
               _DeleteLinkFunc ??= Torque3D.LookupEngineFunction<_DeleteLink>("fnNavMesh_deleteLink");
            ...
            internal static _GetLinkEnd GetLinkEnd() {
               _GetLinkEndFunc ??= Torque3D.LookupEngineFunction<_GetLinkEnd>("fnNavMesh_getLinkEnd");
            ...
            internal static _GetLinkStart GetLinkStart() {
               _GetLinkStartFunc ??= Torque3D.LookupEngineFunction<_GetLinkStart>("fnNavMesh_getLinkStart");
            ...
            internal static _SetLinkFlags SetLinkFlags() {
               _SetLinkFlagsFunc ??= Torque3D.LookupEngineFunction<_SetLinkFlags>("fnNavMesh_setLinkFlags");
            ...
            internal static _GetLinkFlags GetLinkFlags() {
               _GetLinkFlagsFunc ??= Torque3D.LookupEngineFunction<_GetLinkFlags>("fnNavMesh_getLinkFlags");
            ...
            internal static _GetLinkCount GetLinkCount() {
               _GetLinkCountFunc ??= Torque3D.LookupEngineFunction<_GetLinkCount>("fnNavMesh_getLinkCount");
            ...
            internal static _GetLink GetLink() {
               _GetLinkFunc ??= Torque3D.LookupEngineFunction<_GetLink>("fnNavMesh_getLink");
            ...
            internal static _AddLink AddLink() {
               _AddLinkFunc ??= Torque3D.LookupEngineFunction<_AddLink>("fnNavMesh_addLink");
            ...
            internal static _StaticGetType StaticGetType() {
               _StaticGetTypeFunc ??= Torque3D.LookupEngineFunction<_StaticGetType>("fnNavMesh_staticGetType");
            ...
            internal static _Create Create() {
               _CreateFunc ??= Torque3D.LookupEngineFunction<_Create>("fnNavMesh_create");
