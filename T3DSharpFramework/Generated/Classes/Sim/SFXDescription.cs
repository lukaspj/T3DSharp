...
namespace T3DSharpFramework.Generated.Classes.Sim {
    ...
    /// };
    /// </code>
    public class SFXDescription : SimDataBlock {
        ...
        new internal struct InternalUnsafeMethods {
            ...
            internal static _StaticGetType StaticGetType() {
               _StaticGetTypeFunc ??= Torque3D.LookupEngineFunction<_StaticGetType>("fnSFXDescription_staticGetType");
            ...
            internal static _Create Create() {
               _CreateFunc ??= Torque3D.LookupEngineFunction<_Create>("fnSFXDescription_create");
        ...
        /// </description>
        /// <remarks> Per-sound rolloff is only supported on OpenAL at the moment.  With other divices, the global rolloff setting is used for all sounds.
        /// </remarks>
        /// <see cref="LevelInfo::soundDistanceModel" />
        /// </value>
        ...
        /// </description>
        /// <remarks> This field only takes effect when Torque's own sound system performs the streaming. </remarks>
        /// </value>
