...
namespace T3DSharpFramework.Generated.Classes.Sim {
    ...
    /// 
    /// </description>
    public class afxStatusBar : GuiControl {
        ...
        new internal struct InternalUnsafeMethods {
            ...
            internal static _ClearShape ClearShape() {
               _ClearShapeFunc ??= Torque3D.LookupEngineFunction<_ClearShape>("fnafxStatusBar_clearShape");
            ...
            internal static _SetShape SetShape() {
               _SetShapeFunc ??= Torque3D.LookupEngineFunction<_SetShape>("fnafxStatusBar_setShape");
            ...
            internal static _SetProgress SetProgress() {
               _SetProgressFunc ??= Torque3D.LookupEngineFunction<_SetProgress>("fnafxStatusBar_setProgress");
            ...
            internal static _StaticGetType StaticGetType() {
               _StaticGetTypeFunc ??= Torque3D.LookupEngineFunction<_StaticGetType>("fnafxStatusBar_staticGetType");
            ...
            internal static _Create Create() {
               _CreateFunc ??= Torque3D.LookupEngineFunction<_Create>("fnafxStatusBar_create");
