...
namespace T3DSharpFramework.Generated.Classes.Sim {
    ...
    /// </remarks>
    public class Vehicle : RigidShape {
        ...
        new internal struct InternalUnsafeMethods {
            ...
            internal static _StaticGetType StaticGetType() {
               _StaticGetTypeFunc ??= Torque3D.LookupEngineFunction<_StaticGetType>("fnVehicle_staticGetType");
            ...
            internal static _Create Create() {
               _CreateFunc ??= Torque3D.LookupEngineFunction<_Create>("fnVehicle_create");
