...
namespace T3DSharpFramework.Generated.Classes.Sim {
    ...
    /// Editor use only.
    /// </description>
    public class GuiInspectorTypeMaterialAssetPtr : GuiInspectorTypeFileName {
        ...
        new internal struct InternalUnsafeMethods {
            ...
            internal static _StaticGetType StaticGetType() {
               _StaticGetTypeFunc ??= Torque3D.LookupEngineFunction<_StaticGetType>("fnGuiInspectorTypeMaterialAssetPtr_staticGetType");
            ...
            internal static _Create Create() {
               _CreateFunc ??= Torque3D.LookupEngineFunction<_Create>("fnGuiInspectorTypeMaterialAssetPtr_create");
