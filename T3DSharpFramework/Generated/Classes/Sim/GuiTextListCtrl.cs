...
namespace T3DSharpFramework.Generated.Classes.Sim {
    ...
    /// </code>
    /// <see cref="Reference" />
    public class GuiTextListCtrl : GuiArrayCtrl {
        ...
        new internal struct InternalUnsafeMethods {
            ...
            internal static _IsRowActive IsRowActive() {
               _IsRowActiveFunc ??= Torque3D.LookupEngineFunction<_IsRowActive>("fnGuiTextListCtrl_isRowActive");
            ...
            internal static _SetRowActive SetRowActive() {
               _SetRowActiveFunc ??= Torque3D.LookupEngineFunction<_SetRowActive>("fnGuiTextListCtrl_setRowActive");
            ...
            internal static _FindTextIndex FindTextIndex() {
               _FindTextIndexFunc ??= Torque3D.LookupEngineFunction<_FindTextIndex>("fnGuiTextListCtrl_findTextIndex");
            ...
            internal static _ScrollVisible ScrollVisible() {
               _ScrollVisibleFunc ??= Torque3D.LookupEngineFunction<_ScrollVisible>("fnGuiTextListCtrl_scrollVisible");
            ...
            internal static _RemoveRow RemoveRow() {
               _RemoveRowFunc ??= Torque3D.LookupEngineFunction<_RemoveRow>("fnGuiTextListCtrl_removeRow");
            ...
            internal static _RemoveRowById RemoveRowById() {
               _RemoveRowByIdFunc ??= Torque3D.LookupEngineFunction<_RemoveRowById>("fnGuiTextListCtrl_removeRowById");
            ...
            internal static _GetRowText GetRowText() {
               _GetRowTextFunc ??= Torque3D.LookupEngineFunction<_GetRowText>("fnGuiTextListCtrl_getRowText");
            ...
            internal static _GetRowNumById GetRowNumById() {
               _GetRowNumByIdFunc ??= Torque3D.LookupEngineFunction<_GetRowNumById>("fnGuiTextListCtrl_getRowNumById");
            ...
            internal static _GetRowTextById GetRowTextById() {
               _GetRowTextByIdFunc ??= Torque3D.LookupEngineFunction<_GetRowTextById>("fnGuiTextListCtrl_getRowTextById");
            ...
            internal static _GetRowId GetRowId() {
               _GetRowIdFunc ??= Torque3D.LookupEngineFunction<_GetRowId>("fnGuiTextListCtrl_getRowId");
            ...
            internal static _RowCount RowCount() {
               _RowCountFunc ??= Torque3D.LookupEngineFunction<_RowCount>("fnGuiTextListCtrl_rowCount");
            ...
            internal static _Clear Clear() {
               _ClearFunc ??= Torque3D.LookupEngineFunction<_Clear>("fnGuiTextListCtrl_clear");
            ...
            internal static _SortNumerical SortNumerical() {
               _SortNumericalFunc ??= Torque3D.LookupEngineFunction<_SortNumerical>("fnGuiTextListCtrl_sortNumerical");
            ...
            internal static _Sort Sort() {
               _SortFunc ??= Torque3D.LookupEngineFunction<_Sort>("fnGuiTextListCtrl_sort");
            ...
            internal static _SetRowById SetRowById() {
               _SetRowByIdFunc ??= Torque3D.LookupEngineFunction<_SetRowById>("fnGuiTextListCtrl_setRowById");
            ...
            internal static _AddRow AddRow() {
               _AddRowFunc ??= Torque3D.LookupEngineFunction<_AddRow>("fnGuiTextListCtrl_addRow");
            ...
            internal static _ClearSelection ClearSelection() {
               _ClearSelectionFunc ??= Torque3D.LookupEngineFunction<_ClearSelection>("fnGuiTextListCtrl_clearSelection");
            ...
            internal static _GetSelectedRow GetSelectedRow() {
               _GetSelectedRowFunc ??= Torque3D.LookupEngineFunction<_GetSelectedRow>("fnGuiTextListCtrl_getSelectedRow");
            ...
            internal static _SetSelectedRow SetSelectedRow() {
               _SetSelectedRowFunc ??= Torque3D.LookupEngineFunction<_SetSelectedRow>("fnGuiTextListCtrl_setSelectedRow");
            ...
            internal static _SetSelectedById SetSelectedById() {
               _SetSelectedByIdFunc ??= Torque3D.LookupEngineFunction<_SetSelectedById>("fnGuiTextListCtrl_setSelectedById");
            ...
            internal static _GetSelectedId GetSelectedId() {
               _GetSelectedIdFunc ??= Torque3D.LookupEngineFunction<_GetSelectedId>("fnGuiTextListCtrl_getSelectedId");
            ...
            internal static _OnDeleteKey OnDeleteKey() {
               _OnDeleteKeyFunc ??= Torque3D.LookupEngineFunction<_OnDeleteKey>("cbGuiTextListCtrl_onDeleteKey");
            ...
            internal static _OnSelect OnSelect() {
               _OnSelectFunc ??= Torque3D.LookupEngineFunction<_OnSelect>("cbGuiTextListCtrl_onSelect");
            ...
            internal static _StaticGetType StaticGetType() {
               _StaticGetTypeFunc ??= Torque3D.LookupEngineFunction<_StaticGetType>("fnGuiTextListCtrl_staticGetType");
            ...
            internal static _Create Create() {
               _CreateFunc ??= Torque3D.LookupEngineFunction<_Create>("fnGuiTextListCtrl_create");
