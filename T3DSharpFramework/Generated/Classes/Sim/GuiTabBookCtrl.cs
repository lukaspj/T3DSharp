...
namespace T3DSharpFramework.Generated.Classes.Sim {
    ...
    public class GuiTabBookCtrl : GuiContainer {
        ...
        new internal struct InternalUnsafeMethods {
            ...
            internal static _GetSelectedPage GetSelectedPage() {
               _GetSelectedPageFunc ??= Torque3D.LookupEngineFunction<_GetSelectedPage>("fnGuiTabBookCtrl_getSelectedPage");
            ...
            internal static _SelectPage SelectPage() {
               _SelectPageFunc ??= Torque3D.LookupEngineFunction<_SelectPage>("fnGuiTabBookCtrl_selectPage");
            ...
            internal static _AddPage AddPage() {
               _AddPageFunc ??= Torque3D.LookupEngineFunction<_AddPage>("fnGuiTabBookCtrl_addPage");
            ...
            internal static _OnTabRightClick OnTabRightClick() {
               _OnTabRightClickFunc ??= Torque3D.LookupEngineFunction<_OnTabRightClick>("cbGuiTabBookCtrl_onTabRightClick");
            ...
            internal static _OnTabSelected OnTabSelected() {
               _OnTabSelectedFunc ??= Torque3D.LookupEngineFunction<_OnTabSelected>("cbGuiTabBookCtrl_onTabSelected");
            ...
            internal static _StaticGetType StaticGetType() {
               _StaticGetTypeFunc ??= Torque3D.LookupEngineFunction<_StaticGetType>("fnGuiTabBookCtrl_staticGetType");
            ...
            internal static _Create Create() {
               _CreateFunc ??= Torque3D.LookupEngineFunction<_Create>("fnGuiTabBookCtrl_create");
