    ...
    public class Path : GameBase {
        ...
        new internal struct InternalUnsafeMethods {
            ...
            internal static _GetPathId GetPathId() {
               _GetPathIdFunc ??= Torque3D.LookupEngineFunction<_GetPathId>("fnPath_getPathId");
            ...
            internal static _OnAdd OnAdd() {
               _OnAddFunc ??= Torque3D.LookupEngineFunction<_OnAdd>("cbPath_onAdd");
            ...
            internal static _StaticGetType StaticGetType() {
               _StaticGetTypeFunc ??= Torque3D.LookupEngineFunction<_StaticGetType>("fnPath_staticGetType");
            ...
            internal static _Create Create() {
               _CreateFunc ??= Torque3D.LookupEngineFunction<_Create>("fnPath_create");
