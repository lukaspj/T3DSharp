...
namespace T3DSharpFramework.Generated.Classes.Sim {
    ...
    /// };
    /// </code>
    public class GuiSwatchButtonCtrl : GuiButtonBaseCtrl {
        ...
        new internal struct InternalUnsafeMethods {
            ...
            internal static _SetColor SetColor() {
               _SetColorFunc ??= Torque3D.LookupEngineFunction<_SetColor>("fnGuiSwatchButtonCtrl_setColor");
            ...
            internal static _StaticGetType StaticGetType() {
               _StaticGetTypeFunc ??= Torque3D.LookupEngineFunction<_StaticGetType>("fnGuiSwatchButtonCtrl_staticGetType");
            ...
            internal static _Create Create() {
               _CreateFunc ??= Torque3D.LookupEngineFunction<_Create>("fnGuiSwatchButtonCtrl_create");
