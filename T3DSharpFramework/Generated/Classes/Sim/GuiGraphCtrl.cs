...
namespace T3DSharpFramework.Generated.Classes.Sim {
    ...
    /// 
    /// </remarks>
    public class GuiGraphCtrl : GuiControl {
        ...
        new internal struct InternalUnsafeMethods {
            ...
            internal static _MatchScale MatchScale() {
               _MatchScaleFunc ??= Torque3D.LookupEngineFunction<_MatchScale>("fnGuiGraphCtrl_matchScale");
            ...
            internal static _SetGraphType SetGraphType() {
               _SetGraphTypeFunc ??= Torque3D.LookupEngineFunction<_SetGraphType>("fnGuiGraphCtrl_setGraphType");
            ...
            internal static _RemoveAutoPlot RemoveAutoPlot() {
               _RemoveAutoPlotFunc ??= Torque3D.LookupEngineFunction<_RemoveAutoPlot>("fnGuiGraphCtrl_removeAutoPlot");
            ...
            internal static _AddAutoPlot AddAutoPlot() {
               _AddAutoPlotFunc ??= Torque3D.LookupEngineFunction<_AddAutoPlot>("fnGuiGraphCtrl_addAutoPlot");
            ...
            internal static _GetDatum GetDatum() {
               _GetDatumFunc ??= Torque3D.LookupEngineFunction<_GetDatum>("fnGuiGraphCtrl_getDatum");
            ...
            internal static _AddDatum AddDatum() {
               _AddDatumFunc ??= Torque3D.LookupEngineFunction<_AddDatum>("fnGuiGraphCtrl_addDatum");
            ...
            internal static _StaticGetType StaticGetType() {
               _StaticGetTypeFunc ??= Torque3D.LookupEngineFunction<_StaticGetType>("fnGuiGraphCtrl_staticGetType");
            ...
            internal static _Create Create() {
               _CreateFunc ??= Torque3D.LookupEngineFunction<_Create>("fnGuiGraphCtrl_create");
