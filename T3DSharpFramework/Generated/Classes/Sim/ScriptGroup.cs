...
namespace T3DSharpFramework.Generated.Classes.Sim {
    ...
    /// </code>
    /// <see cref="SimGroup" />
    public class ScriptGroup : SimGroup {
        ...
        new internal struct InternalUnsafeMethods {
            ...
            internal static _OnRemove OnRemove() {
               _OnRemoveFunc ??= Torque3D.LookupEngineFunction<_OnRemove>("cbScriptGroup_onRemove");
            ...
            internal static _OnAdd OnAdd() {
               _OnAddFunc ??= Torque3D.LookupEngineFunction<_OnAdd>("cbScriptGroup_onAdd");
            ...
            internal static _StaticGetType StaticGetType() {
               _StaticGetTypeFunc ??= Torque3D.LookupEngineFunction<_StaticGetType>("fnScriptGroup_staticGetType");
            ...
            internal static _Create Create() {
               _CreateFunc ??= Torque3D.LookupEngineFunction<_Create>("fnScriptGroup_create");
