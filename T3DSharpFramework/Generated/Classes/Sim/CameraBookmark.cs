...
namespace T3DSharpFramework.Generated.Classes.Sim {
    ...
    /// </description>
    public class CameraBookmark : MissionMarker {
        ...
        new internal struct InternalUnsafeMethods {
            ...
            internal static _StaticGetType StaticGetType() {
               _StaticGetTypeFunc ??= Torque3D.LookupEngineFunction<_StaticGetType>("fnCameraBookmark_staticGetType");
            ...
            internal static _Create Create() {
               _CreateFunc ??= Torque3D.LookupEngineFunction<_Create>("fnCameraBookmark_create");
