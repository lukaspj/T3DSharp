...
namespace T3DSharpFramework.Generated.Classes.Sim {
    ...
    /// };
    /// </code>
    public class GuiTabPageCtrl : GuiTextCtrl {
        ...
        new internal struct InternalUnsafeMethods {
            ...
            internal static _Select Select() {
               _SelectFunc ??= Torque3D.LookupEngineFunction<_Select>("fnGuiTabPageCtrl_select");
            ...
            internal static _StaticGetType StaticGetType() {
               _StaticGetTypeFunc ??= Torque3D.LookupEngineFunction<_StaticGetType>("fnGuiTabPageCtrl_staticGetType");
            ...
            internal static _Create Create() {
               _CreateFunc ??= Torque3D.LookupEngineFunction<_Create>("fnGuiTabPageCtrl_create");
