...
namespace T3DSharpFramework.Generated.Classes.Sim {
    /// 
    public class NavPath : SceneObject {
        ...
        new internal struct InternalUnsafeMethods {
            ...
            internal static _GetLength GetLength() {
               _GetLengthFunc ??= Torque3D.LookupEngineFunction<_GetLength>("fnNavPath_getLength");
            ...
            internal static _GetFlags GetFlags() {
               _GetFlagsFunc ??= Torque3D.LookupEngineFunction<_GetFlags>("fnNavPath_getFlags");
            ...
            internal static _GetNode GetNode() {
               _GetNodeFunc ??= Torque3D.LookupEngineFunction<_GetNode>("fnNavPath_getNode");
            ...
            internal static _Size Size() {
               _SizeFunc ??= Torque3D.LookupEngineFunction<_Size>("fnNavPath_size");
            ...
            internal static _OnNavMeshUpdateBox OnNavMeshUpdateBox() {
               _OnNavMeshUpdateBoxFunc ??= Torque3D.LookupEngineFunction<_OnNavMeshUpdateBox>("fnNavPath_onNavMeshUpdateBox");
            ...
            internal static _OnNavMeshUpdate OnNavMeshUpdate() {
               _OnNavMeshUpdateFunc ??= Torque3D.LookupEngineFunction<_OnNavMeshUpdate>("fnNavPath_onNavMeshUpdate");
            ...
            internal static _Plan Plan() {
               _PlanFunc ??= Torque3D.LookupEngineFunction<_Plan>("fnNavPath_plan");
            ...
            internal static _StaticGetType StaticGetType() {
               _StaticGetTypeFunc ??= Torque3D.LookupEngineFunction<_StaticGetType>("fnNavPath_staticGetType");
            ...
            internal static _Create Create() {
               _CreateFunc ??= Torque3D.LookupEngineFunction<_Create>("fnNavPath_create");
