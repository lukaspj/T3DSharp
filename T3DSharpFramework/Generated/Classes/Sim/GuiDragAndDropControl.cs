...
namespace T3DSharpFramework.Generated.Classes.Sim {
    ...
    public class GuiDragAndDropControl : GuiControl {
        ...
        new internal struct InternalUnsafeMethods {
            ...
            internal static _StartDragging StartDragging() {
               _StartDraggingFunc ??= Torque3D.LookupEngineFunction<_StartDragging>("fnGuiDragAndDropControl_startDragging");
            ...
            internal static _OnControlDragCancelled OnControlDragCancelled() {
               _OnControlDragCancelledFunc ??= Torque3D.LookupEngineFunction<_OnControlDragCancelled>("cbGuiDragAndDropControl_onControlDragCancelled");
            ...
            internal static _StaticGetType StaticGetType() {
               _StaticGetTypeFunc ??= Torque3D.LookupEngineFunction<_StaticGetType>("fnGuiDragAndDropControl_staticGetType");
            ...
            internal static _Create Create() {
               _CreateFunc ??= Torque3D.LookupEngineFunction<_Create>("fnGuiDragAndDropControl_create");
