...
namespace T3DSharpFramework.Generated.Classes.Sim {
    ...
    /// };
    /// </code>
    public class MissionArea : NetObject {
        ...
        new internal struct InternalUnsafeMethods {
            ...
            internal static _PostApply PostApply() {
               _PostApplyFunc ??= Torque3D.LookupEngineFunction<_PostApply>("fnMissionArea_postApply");
            ...
            internal static _SetArea SetArea() {
               _SetAreaFunc ??= Torque3D.LookupEngineFunction<_SetArea>("fnMissionArea_setArea");
            ...
            internal static _GetArea GetArea() {
               _GetAreaFunc ??= Torque3D.LookupEngineFunction<_GetArea>("fnMissionArea_getArea");
            ...
            internal static _StaticGetType StaticGetType() {
               _StaticGetTypeFunc ??= Torque3D.LookupEngineFunction<_StaticGetType>("fnMissionArea_staticGetType");
            ...
            internal static _Create Create() {
               _CreateFunc ??= Torque3D.LookupEngineFunction<_Create>("fnMissionArea_create");
