...
namespace T3DSharpFramework.Generated.Classes.Sim {
    ...
    /// </description>
    public class GuiFilterCtrl : GuiControl {
        ...
        new internal struct InternalUnsafeMethods {
            ...
            internal static _ResetFiltering ResetFiltering() {
               _ResetFilteringFunc ??= Torque3D.LookupEngineFunction<_ResetFiltering>("fnGuiFilterCtrl_resetFiltering");
            ...
            internal static _SetValue SetValue() {
               _SetValueFunc ??= Torque3D.LookupEngineFunction<_SetValue>("fnGuiFilterCtrl_setValue");
            ...
            internal static _GetValue GetValue() {
               _GetValueFunc ??= Torque3D.LookupEngineFunction<_GetValue>("fnGuiFilterCtrl_getValue");
            ...
            internal static _StaticGetType StaticGetType() {
               _StaticGetTypeFunc ??= Torque3D.LookupEngineFunction<_StaticGetType>("fnGuiFilterCtrl_staticGetType");
            ...
            internal static _Create Create() {
               _CreateFunc ??= Torque3D.LookupEngineFunction<_Create>("fnGuiFilterCtrl_create");
