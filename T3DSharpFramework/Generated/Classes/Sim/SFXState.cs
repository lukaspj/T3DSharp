...
namespace T3DSharpFramework.Generated.Classes.Sim {
    ...
    public class SFXState : SimDataBlock {
        ...
        new internal struct InternalUnsafeMethods {
            ...
            internal static _Enable Enable() {
               _EnableFunc ??= Torque3D.LookupEngineFunction<_Enable>("fnSFXState_enable");
            ...
            internal static _Disable Disable() {
               _DisableFunc ??= Torque3D.LookupEngineFunction<_Disable>("fnSFXState_disable");
            ...
            internal static _IsDisabled IsDisabled() {
               _IsDisabledFunc ??= Torque3D.LookupEngineFunction<_IsDisabled>("fnSFXState_isDisabled");
            ...
            internal static _Deactivate Deactivate() {
               _DeactivateFunc ??= Torque3D.LookupEngineFunction<_Deactivate>("fnSFXState_deactivate");
            ...
            internal static _Activate Activate() {
               _ActivateFunc ??= Torque3D.LookupEngineFunction<_Activate>("fnSFXState_activate");
            ...
            internal static _IsActive IsActive() {
               _IsActiveFunc ??= Torque3D.LookupEngineFunction<_IsActive>("fnSFXState_isActive");
            ...
            internal static _OnDeactivate OnDeactivate() {
               _OnDeactivateFunc ??= Torque3D.LookupEngineFunction<_OnDeactivate>("cbSFXState_onDeactivate");
            ...
            internal static _OnActivate OnActivate() {
               _OnActivateFunc ??= Torque3D.LookupEngineFunction<_OnActivate>("cbSFXState_onActivate");
            ...
            internal static _StaticGetType StaticGetType() {
               _StaticGetTypeFunc ??= Torque3D.LookupEngineFunction<_StaticGetType>("fnSFXState_staticGetType");
            ...
            internal static _Create Create() {
               _CreateFunc ??= Torque3D.LookupEngineFunction<_Create>("fnSFXState_create");
