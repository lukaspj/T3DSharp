...
namespace T3DSharpFramework.Generated.Classes.Sim {
    ...
    public class GuiBitmapButtonTextCtrl : GuiBitmapButtonCtrl {
        ...
        new internal struct InternalUnsafeMethods {
            ...
            internal static _StaticGetType StaticGetType() {
               _StaticGetTypeFunc ??= Torque3D.LookupEngineFunction<_StaticGetType>("fnGuiBitmapButtonTextCtrl_staticGetType");
            ...
            internal static _Create Create() {
               _CreateFunc ??= Torque3D.LookupEngineFunction<_Create>("fnGuiBitmapButtonTextCtrl_create");
