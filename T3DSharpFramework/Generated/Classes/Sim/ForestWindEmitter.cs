...
namespace T3DSharpFramework.Generated.Classes.Sim {
    ...
    /// };
    /// </code>
    public class ForestWindEmitter : SceneObject {
        ...
        new internal struct InternalUnsafeMethods {
            ...
            internal static _AttachToObject AttachToObject() {
               _AttachToObjectFunc ??= Torque3D.LookupEngineFunction<_AttachToObject>("fnForestWindEmitter_attachToObject");
            ...
            internal static _StaticGetType StaticGetType() {
               _StaticGetTypeFunc ??= Torque3D.LookupEngineFunction<_StaticGetType>("fnForestWindEmitter_staticGetType");
            ...
            internal static _Create Create() {
               _CreateFunc ??= Torque3D.LookupEngineFunction<_Create>("fnForestWindEmitter_create");
