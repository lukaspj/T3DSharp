    ...
    public class Marker : SceneObject {
        ...
        new internal struct InternalUnsafeMethods {
            ...
            internal static _StaticGetType StaticGetType() {
               _StaticGetTypeFunc ??= Torque3D.LookupEngineFunction<_StaticGetType>("fnMarker_staticGetType");
            ...
            internal static _Create Create() {
               _CreateFunc ??= Torque3D.LookupEngineFunction<_Create>("fnMarker_create");
        ...
        /// <value>
        /// <description>
        /// The command to execute when a path follower reaches this marker.
        /// </description>
        /// </value>
        public string HitCommand {
            get => GenericMarshal.StringTo<string>(GetFieldValue("hitCommand"));
            set => SetFieldValue("hitCommand", GenericMarshal.ToString(value));
        }
