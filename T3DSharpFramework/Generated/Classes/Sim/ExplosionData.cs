...
namespace T3DSharpFramework.Generated.Classes.Sim {
    ...
    /// 
    /// </description>
    public class ExplosionData : GameBaseData {
        ...
        new internal struct InternalUnsafeMethods {
            ...
            internal static _StaticGetType StaticGetType() {
               _StaticGetTypeFunc ??= Torque3D.LookupEngineFunction<_StaticGetType>("fnExplosionData_staticGetType");
            ...
            internal static _Create Create() {
               _CreateFunc ??= Torque3D.LookupEngineFunction<_Create>("fnExplosionData_create");
        ...
        /// ExplosionShape"
        /// </description>
        /// <summary>Optional shape asset to place at the center of the explosion.\n\n" "The <i>ambient</i> animation of this model will be played automatically at the start of the explosion."</summary>
        /// </value>
        public string ExplosionShapeFile {
            get => GenericMarshal.StringTo<string>(GetFieldValue("ExplosionShapeFile"));
            set => SetFieldValue("ExplosionShapeFile", GenericMarshal.ToString(value));
        }


        /// <value>
        /// <description>
        /// ExplosionShapeasset reference.
        /// </description>
        /// </value>
        public string ExplosionShapeAsset {
            get => GenericMarshal.StringTo<string>(GetFieldValue("ExplosionShapeAsset"));
            set => SetFieldValue("ExplosionShapeAsset", GenericMarshal.ToString(value));
        }


        /// <value>
        /// <description>
        /// Sound"Sound to play when this explosion explodes."
        /// </description>
        /// </value>
