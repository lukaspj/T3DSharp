...
namespace T3DSharpFramework.Generated.Classes.Sim {
    ...
    /// };
    /// </code>
    public class GuiDirectoryFileListCtrl : GuiListBoxCtrl {
        ...
        new internal struct InternalUnsafeMethods {
            ...
            internal static _GetSelectedFile GetSelectedFile() {
               _GetSelectedFileFunc ??= Torque3D.LookupEngineFunction<_GetSelectedFile>("fnGuiDirectoryFileListCtrl_getSelectedFile");
            ...
            internal static _GetSelectedFiles GetSelectedFiles() {
               _GetSelectedFilesFunc ??= Torque3D.LookupEngineFunction<_GetSelectedFiles>("fnGuiDirectoryFileListCtrl_getSelectedFiles");
            ...
            internal static _SetPath SetPath() {
               _SetPathFunc ??= Torque3D.LookupEngineFunction<_SetPath>("fnGuiDirectoryFileListCtrl_setPath");
            ...
            internal static _Reload Reload() {
               _ReloadFunc ??= Torque3D.LookupEngineFunction<_Reload>("fnGuiDirectoryFileListCtrl_reload");
            ...
            internal static _SetFilter SetFilter() {
               _SetFilterFunc ??= Torque3D.LookupEngineFunction<_SetFilter>("fnGuiDirectoryFileListCtrl_setFilter");
            ...
            internal static _StaticGetType StaticGetType() {
               _StaticGetTypeFunc ??= Torque3D.LookupEngineFunction<_StaticGetType>("fnGuiDirectoryFileListCtrl_staticGetType");
            ...
            internal static _Create Create() {
               _CreateFunc ??= Torque3D.LookupEngineFunction<_Create>("fnGuiDirectoryFileListCtrl_create");
