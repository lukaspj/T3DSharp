...
namespace T3DSharpFramework.Generated.Classes.Sim {
    ...
    /// Editor use only.
    /// </description>
    public class GuiInspectorTypeBitMask32 : GuiInspectorField {
        ...
        new internal struct InternalUnsafeMethods {
            ...
            internal static _ApplyBit ApplyBit() {
               _ApplyBitFunc ??= Torque3D.LookupEngineFunction<_ApplyBit>("fnGuiInspectorTypeBitMask32_applyBit");
            ...
            internal static _StaticGetType StaticGetType() {
               _StaticGetTypeFunc ??= Torque3D.LookupEngineFunction<_StaticGetType>("fnGuiInspectorTypeBitMask32_staticGetType");
            ...
            internal static _Create Create() {
               _CreateFunc ??= Torque3D.LookupEngineFunction<_Create>("fnGuiInspectorTypeBitMask32_create");
