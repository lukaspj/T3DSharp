...
namespace T3DSharpFramework.Generated.Classes.Sim {
    ...
    /// instantiation
    /// </code>
    public class GuiControlArrayControl : GuiControl {
        ...
        new internal struct InternalUnsafeMethods {
            ...
            internal static _StaticGetType StaticGetType() {
               _StaticGetTypeFunc ??= Torque3D.LookupEngineFunction<_StaticGetType>("fnGuiControlArrayControl_staticGetType");
            ...
            internal static _Create Create() {
               _CreateFunc ??= Torque3D.LookupEngineFunction<_Create>("fnGuiControlArrayControl_create");
