    ...
    public class ScriptObject : SimObject {
        ...
        new internal struct InternalUnsafeMethods {
            ...
            internal static _OnRemove OnRemove() {
               _OnRemoveFunc ??= Torque3D.LookupEngineFunction<_OnRemove>("cbScriptObject_onRemove");
            ...
            internal static _OnAdd OnAdd() {
               _OnAddFunc ??= Torque3D.LookupEngineFunction<_OnAdd>("cbScriptObject_onAdd");
            ...
            internal static _StaticGetType StaticGetType() {
               _StaticGetTypeFunc ??= Torque3D.LookupEngineFunction<_StaticGetType>("fnScriptObject_staticGetType");
            ...
            internal static _Create Create() {
               _CreateFunc ??= Torque3D.LookupEngineFunction<_Create>("fnScriptObject_create");
