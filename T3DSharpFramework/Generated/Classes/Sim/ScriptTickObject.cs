...
namespace T3DSharpFramework.Generated.Classes.Sim {
    ...
    public class ScriptTickObject : ScriptObject {
        ...
        new internal struct InternalUnsafeMethods {
            ...
            internal static _IsProcessingTicks IsProcessingTicks() {
               _IsProcessingTicksFunc ??= Torque3D.LookupEngineFunction<_IsProcessingTicks>("fnScriptTickObject_isProcessingTicks");
            ...
            internal static _SetProcessTicks SetProcessTicks() {
               _SetProcessTicksFunc ??= Torque3D.LookupEngineFunction<_SetProcessTicks>("fnScriptTickObject_setProcessTicks");
            ...
            internal static _OnAdvanceTime OnAdvanceTime() {
               _OnAdvanceTimeFunc ??= Torque3D.LookupEngineFunction<_OnAdvanceTime>("cbScriptTickObject_onAdvanceTime");
            ...
            internal static _OnProcessTick OnProcessTick() {
               _OnProcessTickFunc ??= Torque3D.LookupEngineFunction<_OnProcessTick>("cbScriptTickObject_onProcessTick");
            ...
            internal static _OnInterpolateTick OnInterpolateTick() {
               _OnInterpolateTickFunc ??= Torque3D.LookupEngineFunction<_OnInterpolateTick>("cbScriptTickObject_onInterpolateTick");
            ...
            internal static _StaticGetType StaticGetType() {
               _StaticGetTypeFunc ??= Torque3D.LookupEngineFunction<_StaticGetType>("fnScriptTickObject_staticGetType");
            ...
            internal static _Create Create() {
               _CreateFunc ??= Torque3D.LookupEngineFunction<_Create>("fnScriptTickObject_create");
