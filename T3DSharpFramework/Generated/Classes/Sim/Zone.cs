    ...
    public class Zone : SceneObject {
        ...
        new internal struct InternalUnsafeMethods {
            ...
            internal static _SelectWithin SelectWithin() {
               _SelectWithinFunc ??= Torque3D.LookupEngineFunction<_SelectWithin>("fnZone_selectWithin");
            ...
            internal static _DumpZoneState DumpZoneState() {
               _DumpZoneStateFunc ??= Torque3D.LookupEngineFunction<_DumpZoneState>("fnZone_dumpZoneState");
            ...
            internal static _GetZoneId GetZoneId() {
               _GetZoneIdFunc ??= Torque3D.LookupEngineFunction<_GetZoneId>("fnZone_getZoneId");
            ...
            internal static _StaticGetType StaticGetType() {
               _StaticGetTypeFunc ??= Torque3D.LookupEngineFunction<_StaticGetType>("fnZone_staticGetType");
            ...
            internal static _Create Create() {
               _CreateFunc ??= Torque3D.LookupEngineFunction<_Create>("fnZone_create");
