...
namespace T3DSharpFramework.Generated.Classes.Sim {
    ...
    public class LangTable : SimObject {
        ...
        new internal struct InternalUnsafeMethods {
            ...
            internal static _GetNumLang GetNumLang() {
               _GetNumLangFunc ??= Torque3D.LookupEngineFunction<_GetNumLang>("fnLangTable_getNumLang");
            ...
            internal static _GetLangName GetLangName() {
               _GetLangNameFunc ??= Torque3D.LookupEngineFunction<_GetLangName>("fnLangTable_getLangName");
            ...
            internal static _GetCurrentLanguage GetCurrentLanguage() {
               _GetCurrentLanguageFunc ??= Torque3D.LookupEngineFunction<_GetCurrentLanguage>("fnLangTable_getCurrentLanguage");
            ...
            internal static _SetCurrentLanguage SetCurrentLanguage() {
               _SetCurrentLanguageFunc ??= Torque3D.LookupEngineFunction<_SetCurrentLanguage>("fnLangTable_setCurrentLanguage");
            ...
            internal static _SetDefaultLanguage SetDefaultLanguage() {
               _SetDefaultLanguageFunc ??= Torque3D.LookupEngineFunction<_SetDefaultLanguage>("fnLangTable_setDefaultLanguage");
            ...
            internal static _GetString GetString() {
               _GetStringFunc ??= Torque3D.LookupEngineFunction<_GetString>("fnLangTable_getString");
            ...
            internal static _AddLanguage AddLanguage() {
               _AddLanguageFunc ??= Torque3D.LookupEngineFunction<_AddLanguage>("fnLangTable_addLanguage");
            ...
            internal static _StaticGetType StaticGetType() {
               _StaticGetTypeFunc ??= Torque3D.LookupEngineFunction<_StaticGetType>("fnLangTable_staticGetType");
            ...
            internal static _Create Create() {
               _CreateFunc ??= Torque3D.LookupEngineFunction<_Create>("fnLangTable_create");
