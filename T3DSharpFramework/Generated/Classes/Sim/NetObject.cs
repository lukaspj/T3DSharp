...
namespace T3DSharpFramework.Generated.Classes.Sim {
    ...
    /// 
    /// </description>
    public class NetObject : SimGroup {
        ...
        new internal struct InternalUnsafeMethods {
            ...
            internal static _ClearScopeAlways ClearScopeAlways() {
               _ClearScopeAlwaysFunc ??= Torque3D.LookupEngineFunction<_ClearScopeAlways>("fnNetObject_clearScopeAlways");
            ...
            internal static _IsServerObject IsServerObject() {
               _IsServerObjectFunc ??= Torque3D.LookupEngineFunction<_IsServerObject>("fnNetObject_isServerObject");
            ...
            internal static _IsClientObject IsClientObject() {
               _IsClientObjectFunc ??= Torque3D.LookupEngineFunction<_IsClientObject>("fnNetObject_isClientObject");
            ...
            internal static _GetServerObject GetServerObject() {
               _GetServerObjectFunc ??= Torque3D.LookupEngineFunction<_GetServerObject>("fnNetObject_getServerObject");
            ...
            internal static _GetClientObject GetClientObject() {
               _GetClientObjectFunc ??= Torque3D.LookupEngineFunction<_GetClientObject>("fnNetObject_getClientObject");
            ...
            internal static _GetGhostID GetGhostID() {
               _GetGhostIDFunc ??= Torque3D.LookupEngineFunction<_GetGhostID>("fnNetObject_getGhostID");
            ...
            internal static _SetScopeAlways SetScopeAlways() {
               _SetScopeAlwaysFunc ??= Torque3D.LookupEngineFunction<_SetScopeAlways>("fnNetObject_setScopeAlways");
            ...
            internal static _ClearScopeToClient ClearScopeToClient() {
               _ClearScopeToClientFunc ??= Torque3D.LookupEngineFunction<_ClearScopeToClient>("fnNetObject_clearScopeToClient");
            ...
            internal static _ScopeToClient ScopeToClient() {
               _ScopeToClientFunc ??= Torque3D.LookupEngineFunction<_ScopeToClient>("fnNetObject_scopeToClient");
            ...
            internal static _StaticGetType StaticGetType() {
               _StaticGetTypeFunc ??= Torque3D.LookupEngineFunction<_StaticGetType>("fnNetObject_staticGetType");
            ...
            internal static _Create Create() {
               _CreateFunc ??= Torque3D.LookupEngineFunction<_Create>("fnNetObject_create");
