...
namespace T3DSharpFramework.Generated.Classes.Sim {
    ...
    /// Editor use only.
    /// </description>
    public class GuiRectHandles : GuiControl {
        ...
        new internal struct InternalUnsafeMethods {
            ...
            internal static _StaticGetType StaticGetType() {
               _StaticGetTypeFunc ??= Torque3D.LookupEngineFunction<_StaticGetType>("fnGuiRectHandles_staticGetType");
            ...
            internal static _Create Create() {
               _CreateFunc ??= Torque3D.LookupEngineFunction<_Create>("fnGuiRectHandles_create");
