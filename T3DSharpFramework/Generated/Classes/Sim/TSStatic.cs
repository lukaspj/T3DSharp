...
namespace T3DSharpFramework.Generated.Classes.Sim {
    ...
    /// };
    /// </code>
    public class TSStatic : SceneObject {
        ...
        new internal struct InternalUnsafeMethods {
            ...
            internal static _GetNodeTransform GetNodeTransform() {
               _GetNodeTransformFunc ??= Torque3D.LookupEngineFunction<_GetNodeTransform>("fnTSStatic_getNodeTransform");
            ...
            internal delegate bool _HasNode(IntPtr _this, HasNode__Args args);
            private static _HasNode _HasNodeFunc;
            internal static _HasNode HasNode() {
               _HasNodeFunc ??= Torque3D.LookupEngineFunction<_HasNode>("fnTSStatic_hasNode");
            ...
            internal static _GetModelFile GetModelFile() {
               _GetModelFileFunc ??= Torque3D.LookupEngineFunction<_GetModelFile>("fnTSStatic_getModelFile");
            ...
            internal static _ChangeMaterial ChangeMaterial() {
               _ChangeMaterialFunc ??= Torque3D.LookupEngineFunction<_ChangeMaterial>("fnTSStatic_changeMaterial");
            ...
            internal static _GetTargetCount GetTargetCount() {
               _GetTargetCountFunc ??= Torque3D.LookupEngineFunction<_GetTargetCount>("fnTSStatic_getTargetCount");
            ...
            internal static _GetTargetName GetTargetName() {
               _GetTargetNameFunc ??= Torque3D.LookupEngineFunction<_GetTargetName>("fnTSStatic_getTargetName");
            ...
            internal static _StaticGetType StaticGetType() {
               _StaticGetTypeFunc ??= Torque3D.LookupEngineFunction<_StaticGetType>("fnTSStatic_staticGetType");
            ...
            internal static _Create Create() {
               _CreateFunc ??= Torque3D.LookupEngineFunction<_Create>("fnTSStatic_create");
        ...
        /// <summary>Get the world transform of the specified node name.</summary>
        /// <description>
        /// 
        /// </description>
        /// <param name="node">name query</param>
        /// <returns>the mount transform</returns>
        public TransformF GetNodeTransform(string nodeName) {
        ...
        /// <summary>Get if this model has this node name.</summary>
        /// <description>
        /// 
        /// </description>
        public bool HasNode(string nodeName) {
             InternalUnsafeMethods.HasNode__Args _args = new InternalUnsafeMethods.HasNode__Args() {
                nodeName = nodeName,
             };
             bool _engineResult = InternalUnsafeMethods.HasNode()(ObjectPtr, _args);
        ...
        /// <value>
        /// <description>
        /// Shape"Model to use for this TSStatic"
        /// </description>
        /// </value>
