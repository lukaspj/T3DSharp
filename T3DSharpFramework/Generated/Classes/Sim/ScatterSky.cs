...
namespace T3DSharpFramework.Generated.Classes.Sim {
    ...
    /// </description>
    public class ScatterSky : SceneObject {
        ...
        new internal struct InternalUnsafeMethods {
            ...
            internal static _ApplyChanges ApplyChanges() {
               _ApplyChangesFunc ??= Torque3D.LookupEngineFunction<_ApplyChanges>("fnScatterSky_applyChanges");
            ...
            internal static _StaticGetType StaticGetType() {
               _StaticGetTypeFunc ??= Torque3D.LookupEngineFunction<_StaticGetType>("fnScatterSky_staticGetType");
            ...
            internal static _Create Create() {
               _CreateFunc ??= Torque3D.LookupEngineFunction<_Create>("fnScatterSky_create");
        ...
        /// <value>
        /// <summary>MoonMat "Material for the moon sprite."</summary>
        /// </value>
        ...
        /// <value>
        /// <summary>MoonMat asset "Material for the moon sprite.".</summary>
        /// </value>
        public string MoonMatAsset {
            get => GenericMarshal.StringTo<string>(GetFieldValue("MoonMatAsset"));
            set => SetFieldValue("MoonMatAsset", GenericMarshal.ToString(value));
        }
