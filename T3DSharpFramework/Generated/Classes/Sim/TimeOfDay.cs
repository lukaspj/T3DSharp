...
namespace T3DSharpFramework.Generated.Classes.Sim {
    ...
    /// };
    /// </code>
    public class TimeOfDay : SceneObject {
        ...
        new internal struct InternalUnsafeMethods {
            ...
            internal static _Animate Animate() {
               _AnimateFunc ??= Torque3D.LookupEngineFunction<_Animate>("fnTimeOfDay_animate");
            ...
            internal static _SetDayLength SetDayLength() {
               _SetDayLengthFunc ??= Torque3D.LookupEngineFunction<_SetDayLength>("fnTimeOfDay_setDayLength");
            ...
            internal static _SetPlay SetPlay() {
               _SetPlayFunc ??= Torque3D.LookupEngineFunction<_SetPlay>("fnTimeOfDay_setPlay");
            ...
            internal static _SetTimeOfDay SetTimeOfDay() {
               _SetTimeOfDayFunc ??= Torque3D.LookupEngineFunction<_SetTimeOfDay>("fnTimeOfDay_setTimeOfDay");
            ...
            internal static _AddTimeOfDayEvent AddTimeOfDayEvent() {
               _AddTimeOfDayEventFunc ??= Torque3D.LookupEngineFunction<_AddTimeOfDayEvent>("fnTimeOfDay_addTimeOfDayEvent");
            ...
            internal static _StaticGetType StaticGetType() {
               _StaticGetTypeFunc ??= Torque3D.LookupEngineFunction<_StaticGetType>("fnTimeOfDay_staticGetType");
            ...
            internal static _Create Create() {
               _CreateFunc ??= Torque3D.LookupEngineFunction<_Create>("fnTimeOfDay_create");
