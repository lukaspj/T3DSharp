    ...
    public class Player : ShapeBase {
        ...
        new internal struct InternalUnsafeMethods {
            ...
            internal static _SetMovementSpeedBias SetMovementSpeedBias() {
               _SetMovementSpeedBiasFunc ??= Torque3D.LookupEngineFunction<_SetMovementSpeedBias>("fnPlayer_setMovementSpeedBias");
            ...
            internal static _CopyHeadRotation CopyHeadRotation() {
               _CopyHeadRotationFunc ??= Torque3D.LookupEngineFunction<_CopyHeadRotation>("fnPlayer_copyHeadRotation");
            ...
            internal static _SetLookAnimationOverride SetLookAnimationOverride() {
               _SetLookAnimationOverrideFunc ??= Torque3D.LookupEngineFunction<_SetLookAnimationOverride>("fnPlayer_setLookAnimationOverride");
            ...
            internal static _IsAnimationLocked IsAnimationLocked() {
               _IsAnimationLockedFunc ??= Torque3D.LookupEngineFunction<_IsAnimationLocked>("fnPlayer_isAnimationLocked");
            ...
            internal static _GetNumDeathAnimations GetNumDeathAnimations() {
               _GetNumDeathAnimationsFunc ??= Torque3D.LookupEngineFunction<_GetNumDeathAnimations>("fnPlayer_getNumDeathAnimations");
            ...
            internal static _CheckDismountPoint CheckDismountPoint() {
               _CheckDismountPointFunc ??= Torque3D.LookupEngineFunction<_CheckDismountPoint>("fnPlayer_checkDismountPoint");
            ...
            internal static _ClearControlObject ClearControlObject() {
               _ClearControlObjectFunc ??= Torque3D.LookupEngineFunction<_ClearControlObject>("fnPlayer_clearControlObject");
            ...
            internal static _GetControlObject GetControlObject() {
               _GetControlObjectFunc ??= Torque3D.LookupEngineFunction<_GetControlObject>("fnPlayer_getControlObject");
            ...
            internal static _SetControlObject SetControlObject() {
               _SetControlObjectFunc ??= Torque3D.LookupEngineFunction<_SetControlObject>("fnPlayer_setControlObject");
            ...
            internal static _SetActionThread SetActionThread() {
               _SetActionThreadFunc ??= Torque3D.LookupEngineFunction<_SetActionThread>("fnPlayer_setActionThread");
            ...
            internal static _SetArmThread SetArmThread() {
               _SetArmThreadFunc ??= Torque3D.LookupEngineFunction<_SetArmThread>("fnPlayer_setArmThread");
            ...
            internal static _GetDamageLocation GetDamageLocation() {
               _GetDamageLocationFunc ??= Torque3D.LookupEngineFunction<_GetDamageLocation>("fnPlayer_getDamageLocation");
            ...
            internal static _GetState GetState() {
               _GetStateFunc ??= Torque3D.LookupEngineFunction<_GetState>("fnPlayer_getState");
            ...
            internal static _AllowSwimming AllowSwimming() {
               _AllowSwimmingFunc ??= Torque3D.LookupEngineFunction<_AllowSwimming>("fnPlayer_allowSwimming");
            ...
            internal static _AllowProne AllowProne() {
               _AllowProneFunc ??= Torque3D.LookupEngineFunction<_AllowProne>("fnPlayer_allowProne");
            ...
            internal static _AllowCrouching AllowCrouching() {
               _AllowCrouchingFunc ??= Torque3D.LookupEngineFunction<_AllowCrouching>("fnPlayer_allowCrouching");
            ...
            internal static _AllowSprinting AllowSprinting() {
               _AllowSprintingFunc ??= Torque3D.LookupEngineFunction<_AllowSprinting>("fnPlayer_allowSprinting");
            ...
            internal static _AllowJetJumping AllowJetJumping() {
               _AllowJetJumpingFunc ??= Torque3D.LookupEngineFunction<_AllowJetJumping>("fnPlayer_allowJetJumping");
            ...
            internal static _AllowJumping AllowJumping() {
               _AllowJumpingFunc ??= Torque3D.LookupEngineFunction<_AllowJumping>("fnPlayer_allowJumping");
            ...
            internal static _AllowAllPoses AllowAllPoses() {
               _AllowAllPosesFunc ??= Torque3D.LookupEngineFunction<_AllowAllPoses>("fnPlayer_allowAllPoses");
            ...
            internal static _GetPose GetPose() {
               _GetPoseFunc ??= Torque3D.LookupEngineFunction<_GetPose>("fnPlayer_getPose");
            ...
            internal static _StaticGetType StaticGetType() {
               _StaticGetTypeFunc ??= Torque3D.LookupEngineFunction<_StaticGetType>("fnPlayer_staticGetType");
            ...
            internal static _Create Create() {
               _CreateFunc ??= Torque3D.LookupEngineFunction<_Create>("fnPlayer_create");
