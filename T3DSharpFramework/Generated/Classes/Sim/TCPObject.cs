...
namespace T3DSharpFramework.Generated.Classes.Sim {
    ...
    /// </code>
    /// <see cref="HTTPObject" />
    public class TCPObject : SimObject {
        ...
        new internal struct InternalUnsafeMethods {
            ...
            internal static _Disconnect Disconnect() {
               _DisconnectFunc ??= Torque3D.LookupEngineFunction<_Disconnect>("fnTCPObject_disconnect");
            ...
            internal static _Connect Connect() {
               _ConnectFunc ??= Torque3D.LookupEngineFunction<_Connect>("fnTCPObject_connect");
            ...
            internal static _Listen Listen() {
               _ListenFunc ??= Torque3D.LookupEngineFunction<_Listen>("fnTCPObject_listen");
            ...
            internal static _FinishLastLine FinishLastLine() {
               _FinishLastLineFunc ??= Torque3D.LookupEngineFunction<_FinishLastLine>("fnTCPObject_finishLastLine");
            ...
            internal static _SendFile SendFile() {
               _SendFileFunc ??= Torque3D.LookupEngineFunction<_SendFile>("fnTCPObject_sendFile");
            ...
            internal static _Send Send() {
               _SendFunc ??= Torque3D.LookupEngineFunction<_Send>("fnTCPObject_send");
            ...
            internal static _OnDisconnect OnDisconnect() {
               _OnDisconnectFunc ??= Torque3D.LookupEngineFunction<_OnDisconnect>("cbTCPObject_onDisconnect");
            ...
            internal static _OnConnectFailed OnConnectFailed() {
               _OnConnectFailedFunc ??= Torque3D.LookupEngineFunction<_OnConnectFailed>("cbTCPObject_onConnectFailed");
            ...
            internal static _OnConnected OnConnected() {
               _OnConnectedFunc ??= Torque3D.LookupEngineFunction<_OnConnected>("cbTCPObject_onConnected");
            ...
            internal static _OnDNSFailed OnDNSFailed() {
               _OnDNSFailedFunc ??= Torque3D.LookupEngineFunction<_OnDNSFailed>("cbTCPObject_onDNSFailed");
            ...
            internal static _OnDNSResolved OnDNSResolved() {
               _OnDNSResolvedFunc ??= Torque3D.LookupEngineFunction<_OnDNSResolved>("cbTCPObject_onDNSResolved");
            ...
            internal static _OnEndReceive OnEndReceive() {
               _OnEndReceiveFunc ??= Torque3D.LookupEngineFunction<_OnEndReceive>("cbTCPObject_onEndReceive");
            ...
            internal static _OnPacket OnPacket() {
               _OnPacketFunc ??= Torque3D.LookupEngineFunction<_OnPacket>("cbTCPObject_onPacket");
            ...
            internal static _OnLine OnLine() {
               _OnLineFunc ??= Torque3D.LookupEngineFunction<_OnLine>("cbTCPObject_onLine");
            ...
            internal static _OnConnectionRequest OnConnectionRequest() {
               _OnConnectionRequestFunc ??= Torque3D.LookupEngineFunction<_OnConnectionRequest>("cbTCPObject_onConnectionRequest");
            ...
            internal static _StaticGetType StaticGetType() {
               _StaticGetTypeFunc ??= Torque3D.LookupEngineFunction<_StaticGetType>("fnTCPObject_staticGetType");
            ...
            internal static _Create Create() {
               _CreateFunc ??= Torque3D.LookupEngineFunction<_Create>("fnTCPObject_create");
