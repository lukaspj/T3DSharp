...
namespace T3DSharpFramework.Generated.Classes.Sim {
    ...
    public class SFXSound : SFXSource {
        ...
        new internal struct InternalUnsafeMethods {
            ...
            internal static _GetDuration GetDuration() {
               _GetDurationFunc ??= Torque3D.LookupEngineFunction<_GetDuration>("fnSFXSound_getDuration");
            ...
            internal static _SetPosition SetPosition() {
               _SetPositionFunc ??= Torque3D.LookupEngineFunction<_SetPosition>("fnSFXSound_setPosition");
            ...
            internal static _GetPosition GetPosition() {
               _GetPositionFunc ??= Torque3D.LookupEngineFunction<_GetPosition>("fnSFXSound_getPosition");
            ...
            internal static _IsReady IsReady() {
               _IsReadyFunc ??= Torque3D.LookupEngineFunction<_IsReady>("fnSFXSound_isReady");
            ...
            internal static _StaticGetType StaticGetType() {
               _StaticGetTypeFunc ??= Torque3D.LookupEngineFunction<_StaticGetType>("fnSFXSound_staticGetType");
            ...
            internal static _Create Create() {
               _CreateFunc ??= Torque3D.LookupEngineFunction<_Create>("fnSFXSound_create");
