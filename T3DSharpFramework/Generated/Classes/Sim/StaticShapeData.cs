...
namespace T3DSharpFramework.Generated.Classes.Sim {
    ...
    /// <see cref="TSStatic" />
    public class StaticShapeData : ShapeBaseData {
        ...
        new internal struct InternalUnsafeMethods {
            ...
            internal static _StaticGetType StaticGetType() {
               _StaticGetTypeFunc ??= Torque3D.LookupEngineFunction<_StaticGetType>("fnStaticShapeData_staticGetType");
            ...
            internal static _Create Create() {
               _CreateFunc ??= Torque3D.LookupEngineFunction<_Create>("fnStaticShapeData_create");
