...
namespace T3DSharpFramework.Generated.Classes.Sim {
    /// 
    public class ModuleDefinition : SimSet {
        ...
        new internal struct InternalUnsafeMethods {
            ...
            internal static _StaticGetType StaticGetType() {
               _StaticGetTypeFunc ??= Torque3D.LookupEngineFunction<_StaticGetType>("fnModuleDefinition_staticGetType");
            ...
            internal static _Create Create() {
               _CreateFunc ??= Torque3D.LookupEngineFunction<_Create>("fnModuleDefinition_create");
            ...
            internal static _RemoveDependency RemoveDependency() {
               _RemoveDependencyFunc ??= Torque3D.LookupEngineFunction<_RemoveDependency>("fnModuleDefinition_removeDependency");
            ...
            internal static _AddDependency AddDependency() {
               _AddDependencyFunc ??= Torque3D.LookupEngineFunction<_AddDependency>("fnModuleDefinition_addDependency");
            ...
            internal static _GetDependency GetDependency() {
               _GetDependencyFunc ??= Torque3D.LookupEngineFunction<_GetDependency>("fnModuleDefinition_getDependency");
            ...
            internal static _GetDependencyCount GetDependencyCount() {
               _GetDependencyCountFunc ??= Torque3D.LookupEngineFunction<_GetDependencyCount>("fnModuleDefinition_getDependencyCount");
            ...
            internal static _GetModuleManager GetModuleManager() {
               _GetModuleManagerFunc ??= Torque3D.LookupEngineFunction<_GetModuleManager>("fnModuleDefinition_getModuleManager");
            ...
            internal static _Save Save() {
               _SaveFunc ??= Torque3D.LookupEngineFunction<_Save>("fnModuleDefinition_save");
