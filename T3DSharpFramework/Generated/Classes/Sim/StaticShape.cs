    ...
    public class StaticShape : ShapeBase {
        ...
        new internal struct InternalUnsafeMethods {
            ...
            internal static _GetPoweredState GetPoweredState() {
               _GetPoweredStateFunc ??= Torque3D.LookupEngineFunction<_GetPoweredState>("fnStaticShape_getPoweredState");
            ...
            internal static _SetPoweredState SetPoweredState() {
               _SetPoweredStateFunc ??= Torque3D.LookupEngineFunction<_SetPoweredState>("fnStaticShape_setPoweredState");
            ...
            internal static _StaticGetType StaticGetType() {
               _StaticGetTypeFunc ??= Torque3D.LookupEngineFunction<_StaticGetType>("fnStaticShape_staticGetType");
            ...
            internal static _Create Create() {
               _CreateFunc ??= Torque3D.LookupEngineFunction<_Create>("fnStaticShape_create");
