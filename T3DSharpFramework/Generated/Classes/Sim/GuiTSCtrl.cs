...
namespace T3DSharpFramework.Generated.Classes.Sim {
    ...
    public class GuiTSCtrl : GuiContainer {
        ...
        new internal struct InternalUnsafeMethods {
            ...
            internal static _SetStereoGui SetStereoGui() {
               _SetStereoGuiFunc ??= Torque3D.LookupEngineFunction<_SetStereoGui>("fnGuiTSCtrl_setStereoGui");
            ...
            internal static _CalculateViewDistance CalculateViewDistance() {
               _CalculateViewDistanceFunc ??= Torque3D.LookupEngineFunction<_CalculateViewDistance>("fnGuiTSCtrl_calculateViewDistance");
            ...
            internal static _GetWorldToScreenScale GetWorldToScreenScale() {
               _GetWorldToScreenScaleFunc ??= Torque3D.LookupEngineFunction<_GetWorldToScreenScale>("fnGuiTSCtrl_getWorldToScreenScale");
            ...
            internal static _Project Project() {
               _ProjectFunc ??= Torque3D.LookupEngineFunction<_Project>("fnGuiTSCtrl_project");
            ...
            internal static _Unproject Unproject() {
               _UnprojectFunc ??= Torque3D.LookupEngineFunction<_Unproject>("fnGuiTSCtrl_unproject");
            ...
            internal static _StaticGetType StaticGetType() {
               _StaticGetTypeFunc ??= Torque3D.LookupEngineFunction<_StaticGetType>("fnGuiTSCtrl_staticGetType");
            ...
            internal static _Create Create() {
               _CreateFunc ??= Torque3D.LookupEngineFunction<_Create>("fnGuiTSCtrl_create");
