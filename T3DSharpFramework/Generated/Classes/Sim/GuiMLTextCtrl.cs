...
namespace T3DSharpFramework.Generated.Classes.Sim {
    ...
    /// </code>
    /// <see cref="GuiControl" />
    public class GuiMLTextCtrl : GuiControl {
        ...
        new internal struct InternalUnsafeMethods {
            ...
            internal static _SetAlpha SetAlpha() {
               _SetAlphaFunc ??= Torque3D.LookupEngineFunction<_SetAlpha>("fnGuiMLTextCtrl_setAlpha");
            ...
            internal static _ForceReflow ForceReflow() {
               _ForceReflowFunc ??= Torque3D.LookupEngineFunction<_ForceReflow>("fnGuiMLTextCtrl_forceReflow");
            ...
            internal static _ScrollToBottom ScrollToBottom() {
               _ScrollToBottomFunc ??= Torque3D.LookupEngineFunction<_ScrollToBottom>("fnGuiMLTextCtrl_scrollToBottom");
            ...
            internal static _ScrollToTop ScrollToTop() {
               _ScrollToTopFunc ??= Torque3D.LookupEngineFunction<_ScrollToTop>("fnGuiMLTextCtrl_scrollToTop");
            ...
            internal static _ScrollToTag ScrollToTag() {
               _ScrollToTagFunc ??= Torque3D.LookupEngineFunction<_ScrollToTag>("fnGuiMLTextCtrl_scrollToTag");
            ...
            internal static _SetCursorPosition SetCursorPosition() {
               _SetCursorPositionFunc ??= Torque3D.LookupEngineFunction<_SetCursorPosition>("fnGuiMLTextCtrl_setCursorPosition");
            ...
            internal static _AddText AddText() {
               _AddTextFunc ??= Torque3D.LookupEngineFunction<_AddText>("fnGuiMLTextCtrl_addText");
            ...
            internal static _GetText GetText() {
               _GetTextFunc ??= Torque3D.LookupEngineFunction<_GetText>("fnGuiMLTextCtrl_getText");
            ...
            internal static _SetText SetText() {
               _SetTextFunc ??= Torque3D.LookupEngineFunction<_SetText>("fnGuiMLTextCtrl_setText");
            ...
            internal static _OnResize OnResize() {
               _OnResizeFunc ??= Torque3D.LookupEngineFunction<_OnResize>("cbGuiMLTextCtrl_onResize");
            ...
            internal static _OnURL OnURL() {
               _OnURLFunc ??= Torque3D.LookupEngineFunction<_OnURL>("cbGuiMLTextCtrl_onURL");
            ...
            internal static _StaticGetType StaticGetType() {
               _StaticGetTypeFunc ??= Torque3D.LookupEngineFunction<_StaticGetType>("fnGuiMLTextCtrl_staticGetType");
            ...
            internal static _Create Create() {
               _CreateFunc ??= Torque3D.LookupEngineFunction<_Create>("fnGuiMLTextCtrl_create");
        ...
        /// <value>
        /// <description>
        /// DeniedSound"If the text will not fit in the control, the deniedSound is played."
        /// </description>
        /// </value>
        public string DeniedSoundFile {
            get => GenericMarshal.StringTo<string>(GetFieldValue("DeniedSoundFile"));
            set => SetFieldValue("DeniedSoundFile", GenericMarshal.ToString(value));
        }


        /// <value>
        /// <description>
        /// DeniedSoundasset reference.
        /// </description>
        /// </value>
        public string DeniedSoundAsset {
            get => GenericMarshal.StringTo<string>(GetFieldValue("DeniedSoundAsset"));
            set => SetFieldValue("DeniedSoundAsset", GenericMarshal.ToString(value));
        }
