...
namespace T3DSharpFramework.Generated.Classes.Sim {
    ...
    public class RenderTexTargetBinManager : RenderBinManager {
        ...
        new internal struct InternalUnsafeMethods {
            ...
            internal static _StaticGetType StaticGetType() {
               _StaticGetTypeFunc ??= Torque3D.LookupEngineFunction<_StaticGetType>("fnRenderTexTargetBinManager_staticGetType");
            ...
            internal static _Create Create() {
               _CreateFunc ??= Torque3D.LookupEngineFunction<_Create>("fnRenderTexTargetBinManager_create");
