...
namespace T3DSharpFramework.Generated.Classes.Sim {
    ...
    /// 
    /// </description>
    public class afxEffectron : afxChoreographer {
        ...
        new internal struct InternalUnsafeMethods {
            ...
            internal static _Activate Activate() {
               _ActivateFunc ??= Torque3D.LookupEngineFunction<_Activate>("fnafxEffectron_activate");
            ...
            internal static _Interrupt Interrupt() {
               _InterruptFunc ??= Torque3D.LookupEngineFunction<_Interrupt>("fnafxEffectron_interrupt");
            ...
            internal static _SetTimeFactor SetTimeFactor() {
               _SetTimeFactorFunc ??= Torque3D.LookupEngineFunction<_SetTimeFactor>("fnafxEffectron_setTimeFactor");
            ...
            internal static _StaticGetType StaticGetType() {
               _StaticGetTypeFunc ??= Torque3D.LookupEngineFunction<_StaticGetType>("fnafxEffectron_staticGetType");
            ...
            internal static _Create Create() {
               _CreateFunc ??= Torque3D.LookupEngineFunction<_Create>("fnafxEffectron_create");
