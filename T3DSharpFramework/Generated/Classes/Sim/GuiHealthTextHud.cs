...
namespace T3DSharpFramework.Generated.Classes.Sim {
    ...
    /// };
    /// </code>
    public class GuiHealthTextHud : GuiControl {
        ...
        new internal struct InternalUnsafeMethods {
            ...
            internal static _StaticGetType StaticGetType() {
               _StaticGetTypeFunc ??= Torque3D.LookupEngineFunction<_StaticGetType>("fnGuiHealthTextHud_staticGetType");
            ...
            internal static _Create Create() {
               _CreateFunc ??= Torque3D.LookupEngineFunction<_Create>("fnGuiHealthTextHud_create");
