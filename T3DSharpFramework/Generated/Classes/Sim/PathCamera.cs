...
namespace T3DSharpFramework.Generated.Classes.Sim {
    ...
    /// };
    /// </code>
    public class PathCamera : ShapeBase {
        ...
        new internal struct InternalUnsafeMethods {
            ...
            internal static _PopFront PopFront() {
               _PopFrontFunc ??= Torque3D.LookupEngineFunction<_PopFront>("fnPathCamera_popFront");
            ...
            internal static _PushFront PushFront() {
               _PushFrontFunc ??= Torque3D.LookupEngineFunction<_PushFront>("fnPathCamera_pushFront");
            ...
            internal static _PushBack PushBack() {
               _PushBackFunc ??= Torque3D.LookupEngineFunction<_PushBack>("fnPathCamera_pushBack");
            ...
            internal static _Reset Reset() {
               _ResetFunc ??= Torque3D.LookupEngineFunction<_Reset>("fnPathCamera_reset");
            ...
            internal static _SetState SetState() {
               _SetStateFunc ??= Torque3D.LookupEngineFunction<_SetState>("fnPathCamera_setState");
            ...
            internal static _SetTarget SetTarget() {
               _SetTargetFunc ??= Torque3D.LookupEngineFunction<_SetTarget>("fnPathCamera_setTarget");
            ...
            internal static _SetPosition SetPosition() {
               _SetPositionFunc ??= Torque3D.LookupEngineFunction<_SetPosition>("fnPathCamera_setPosition");
            ...
            internal static _OnNode OnNode() {
               _OnNodeFunc ??= Torque3D.LookupEngineFunction<_OnNode>("cbPathCamera_onNode");
            ...
            internal static _StaticGetType StaticGetType() {
               _StaticGetTypeFunc ??= Torque3D.LookupEngineFunction<_StaticGetType>("fnPathCamera_staticGetType");
            ...
            internal static _Create Create() {
               _CreateFunc ??= Torque3D.LookupEngineFunction<_Create>("fnPathCamera_create");
