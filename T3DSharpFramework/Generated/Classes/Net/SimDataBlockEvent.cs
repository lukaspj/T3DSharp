...
namespace T3DSharpFramework.Generated.Classes.Net {
    ...
    /// </description>
    public class SimDataBlockEvent : NetEvent {
        ...
        new internal struct InternalUnsafeMethods {
            ...
            internal static _StaticGetType StaticGetType() {
               _StaticGetTypeFunc ??= Torque3D.LookupEngineFunction<_StaticGetType>("fnSimDataBlockEvent_staticGetType");
            ...
            internal static _Create Create() {
               _CreateFunc ??= Torque3D.LookupEngineFunction<_Create>("fnSimDataBlockEvent_create");
