...
namespace T3DSharpFramework.Generated.Classes.Net {
    ...
    /// Editor use only.
    /// </description>
    public class DecalRoadNodeEvent : NodeListEvent {
        ...
        new internal struct InternalUnsafeMethods {
            ...
            internal static _StaticGetType StaticGetType() {
               _StaticGetTypeFunc ??= Torque3D.LookupEngineFunction<_StaticGetType>("fnDecalRoadNodeEvent_staticGetType");
            ...
            internal static _Create Create() {
               _CreateFunc ??= Torque3D.LookupEngineFunction<_Create>("fnDecalRoadNodeEvent_create");
