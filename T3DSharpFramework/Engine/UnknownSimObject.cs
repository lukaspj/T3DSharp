   ...
   public class UnknownSimObject : ConsoleObjectBase, ISimObject {
      ...
      new internal struct InternalUnsafeMethods {
         ...
         internal struct SetFieldValue__Args {
            [MarshalAs(UnmanagedType.LPUTF8Str)] internal string fieldName;
            [MarshalAs(UnmanagedType.LPUTF8Str)] internal string value;
            internal int index;
         }
         ...
         internal static _GetClassNamespace GetClassNamespace() {
            _GetClassNamespaceFunc ??=
               Torque3D.LookupEngineFunction<_GetClassNamespace>("fnSimObject_getClassNamespace");
