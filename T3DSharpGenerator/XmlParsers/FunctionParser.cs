...
namespace T3DSharpGenerator.XmlParsers {
   internal class FunctionParser : IApiXmlParser {
      ...
      public ParseState Parse(XmlElement element, ParseState parseState) {
         ...
         bool isCallback = ValueParser.ParseBool(element.Attributes["isCallback"].InnerText);
         bool isVariadic = ValueParser.ParseBool(element.Attributes["isVariadic"].InnerText);
